! function () {
    ...
    1: [function (require, module, exports) {
        ...
        require("./src/components/math"), require("./src/components/body/ammo-body"), require("./src/components/body/body"), require("./src/components/body/dynamic-body"), require("./src/components/body/static-body"), require("./src/components/shape/shape"), require("./src/components/shape/ammo-shape"), require("./src/components/ammo-constraint"), require("./src/components/constraint"), require("./src/components/spring"), require("./src/system"), module.exports = {
            registerAll: function () {
                console.warn("registerAll() is deprecated. Components are automatically registered.")
            }
        }, window.CANNON = window.CANNON || CANNON
    }, {
        "./src/components/ammo-constraint": 65,
        "./src/components/body/ammo-body": 66,
        "./src/components/body/body": 67,
        "./src/components/body/dynamic-body": 68,
        "./src/components/body/static-body": 69,
        "./src/components/constraint": 70,
        "./src/components/math": 71,
        "./src/components/shape/ammo-shape": 73,
        "./src/components/shape/shape": 74,
        "./src/components/spring": 75,
        "./src/system": 85,
        cannon: 5
    }],
            ...
            for (var obj = new THREE.Object3D, l = 0; l < body.shapes.length; l++) {
                ...
                switch (shape.type) {
                    ...
                    case CANNON.Shape.types.PLANE:
                        ...
                        ground.scale.set(100, 100, 100), submesh.add(ground), ground.castShadow = !0, ground.receiveShadow = !0, mesh.add(submesh);
                        break;
                    ...
                    case CANNON.Shape.types.HEIGHTFIELD:
                        ...
                        for (var v0 = new CANNON.Vec3, v1 = new CANNON.Vec3, v2 = new CANNON.Vec3, xi = 0; xi < shape.data.length - 1; xi++)
                            for (var yi = 0; yi < shape.data[xi].length - 1; yi++)
                                for (var k = 0; k < 2; k++) {
                                    shape.getConvexTrianglePillar(xi, yi, 0 === k), v0.copy(shape.pillarConvex.vertices[0]), v1.copy(shape.pillarConvex.vertices[1]), v2.copy(shape.pillarConvex.vertices[2]), v0.vadd(shape.pillarOffset, v0), v1.vadd(shape.pillarOffset, v1), v2.vadd(shape.pillarOffset, v2), geometry.vertices.push(new THREE.Vector3(v0.x, v0.y, v0.z), new THREE.Vector3(v1.x, v1.y, v1.z), new THREE.Vector3(v2.x, v2.y, v2.z));
                                    i = geometry.vertices.length - 3;
                                    geometry.faces.push(new THREE.Face3(i, i + 1, i + 2))
                                }
                        geometry.computeBoundingSphere(), geometry.computeFaceNormals(), mesh = new THREE.Mesh(geometry, this.currentMaterial);
                        break;
                    case CANNON.Shape.types.TRIMESH:
                        for (geometry = new THREE.Geometry, v0 = new CANNON.Vec3, v1 = new CANNON.Vec3, v2 = new CANNON.Vec3, i = 0; i < shape.indices.length / 3; i++) {
                ...
                if (mesh.receiveShadow = !0, mesh.castShadow = !0, mesh.children)
                    for (i = 0; i < mesh.children.length; i++)
                        if (mesh.children[i].castShadow = !0, mesh.children[i].receiveShadow = !0, mesh.children[i])
                            for (j = 0; j < mesh.children[i].length; j++) mesh.children[i].children[j].castShadow = !0, mesh.children[i].children[j].receiveShadow = !0;
    ...
    3: [function (require, module, exports) {
        THREE.AmmoDebugConstants = {
            ...
            var drawOnTop = this.debugDrawMode & THREE.AmmoDebugConstants.DrawOnTop || !1,
                maxBufferSize = options.maxBufferSize || 1e6;
            this.geometry = new THREE.BufferGeometry;
            var vertices = new Float32Array(3 * maxBufferSize),
                colors = new Float32Array(3 * maxBufferSize);
            this.geometry.addAttribute("position", new THREE.BufferAttribute(vertices, 3).setDynamic(!0)), this.geometry.addAttribute("color", new THREE.BufferAttribute(colors, 3).setDynamic(!0)), this.index = 0;
            var material = new THREE.LineBasicMaterial({
                vertexColors: THREE.VertexColors,
                depthTest: !drawOnTop
            });
            this.mesh = new THREE.LineSegments(this.geometry, material), drawOnTop && (this.mesh.renderOrder = 999), this.mesh.frustumCulled = !1, this.enabled = !1, this.debugDrawer = new Ammo.DebugDrawer, this.debugDrawer.drawLine = this.drawLine.bind(this), this.debugDrawer.drawContactPoint = this.drawContactPoint.bind(this), this.debugDrawer.reportErrorWarning = this.reportErrorWarning.bind(this), this.debugDrawer.draw3dText = this.draw3dText.bind(this), this.debugDrawer.setDebugMode = this.setDebugMode.bind(this), this.debugDrawer.getDebugMode = this.getDebugMode.bind(this), this.debugDrawer.enable = this.enable.bind(this), this.debugDrawer.disable = this.disable.bind(this), this.debugDrawer.update = this.update.bind(this), this.world.setDebugDrawer(this.debugDrawer)
            ...
            this.enabled && (0 != this.index && (this.geometry.attributes.position.needsUpdate = !0, this.geometry.attributes.color.needsUpdate = !0), this.index = 0, this.world.debugDrawWorld(), this.geometry.setDrawRange(0, this.index))
            ...
            const heap = Ammo.HEAPF32,
                ...
                fromY = heap[(from + 4) / 4],
                fromZ = heap[(from + 8) / 4];
            this.geometry.attributes.position.setXYZ(this.index, fromX, fromY, fromZ), this.geometry.attributes.color.setXYZ(this.index++, r, g, b);
            const toX = heap[(to + 0) / 4],
                toY = heap[(to + 4) / 4],
                toZ = heap[(to + 8) / 4];
            this.geometry.attributes.position.setXYZ(this.index, toX, toY, toZ), this.geometry.attributes.color.setXYZ(this.index++, r, g, b)
            ...
            const dx = heap[(normalOnB + 0) / 4] * distance,
                ...
                dz = heap[(normalOnB + 8) / 4] * distance;
            this.geometry.attributes.position.setXYZ(this.index, x + dx, y + dy, z + dz), this.geometry.attributes.color.setXYZ(this.index++, r, g, b)
        }, THREE.AmmoDebugDrawer.prototype.reportErrorWarning = function (warningString) {
            Ammo.hasOwnProperty("Pointer_stringify") ? console.warn(Ammo.Pointer_stringify(warningString)) : this.warnedOnce || (this.warnedOnce = !0, console.warn("Cannot print warningString, please rebuild Ammo.js using 'debug' flag"))
    ...
    5: [function (require, module, exports) {
        ...
        "./math/Vec3": 34,
        "./objects/Body": 35,
        "./objects/RaycastVehicle": 36,
        "./objects/RigidVehicle": 37,
        "./objects/SPHSystem": 38,
        "./objects/Spring": 39,
        "./shapes/Box": 41,
        "./shapes/ConvexPolyhedron": 42,
        "./shapes/Cylinder": 43,
        "./shapes/Heightfield": 44,
        "./shapes/Particle": 45,
        "./shapes/Plane": 46,
        "./shapes/Shape": 47,
        "./shapes/Sphere": 48,
        ...
        "./solver/GSSolver": 50,
        "./solver/Solver": 51,
        "./solver/SplitSolver": 52,
        "./utils/EventTarget": 53,
        "./utils/Pool": 55,
        "./utils/Vec3Pool": 58,
        "./world/Narrowphase": 59,
        "./world/World": 60
    }],
    6: [function (require, module, exports) {
        ...
        function AABB(options) {
            options = options || {}, this.lowerBound = new Vec3, options.lowerBound && this.lowerBound.copy(options.lowerBound), this.upperBound = new Vec3, options.upperBound && this.upperBound.copy(options.upperBound)
        }
        module.exports = AABB;
        var tmp = new Vec3;
        AABB.prototype.setFromPoints = function (points, position, quaternion, skinSize) {
            ...
            for (var i = 1; i < points.length; i++) {
                var p = points[i];
                q && (q.vmult(p, tmp), p = tmp), p.x > u.x && (u.x = p.x), p.x < l.x && (l.x = p.x), p.y > u.y && (u.y = p.y), p.y < l.y && (l.y = p.y), p.z > u.z && (u.z = p.z), p.z < l.z && (l.z = p.z)
            }
            return position && (position.vadd(l, l), position.vadd(u, u)), skinSize && (l.x -= skinSize, l.y -= skinSize, l.z -= skinSize, u.x += skinSize, u.y += skinSize, u.z += skinSize), this
        }, AABB.prototype.copy = function (aabb) {
            return this.lowerBound.copy(aabb.lowerBound), this.upperBound.copy(aabb.upperBound), this
        }, AABB.prototype.clone = function () {
            return (new AABB).copy(this)
        }, AABB.prototype.extend = function (aabb) {
            this.lowerBound.x = Math.min(this.lowerBound.x, aabb.lowerBound.x), this.upperBound.x = Math.max(this.upperBound.x, aabb.upperBound.x), this.lowerBound.y = Math.min(this.lowerBound.y, aabb.lowerBound.y), this.upperBound.y = Math.max(this.upperBound.y, aabb.upperBound.y), this.lowerBound.z = Math.min(this.lowerBound.z, aabb.lowerBound.z), this.upperBound.z = Math.max(this.upperBound.z, aabb.upperBound.z)
            ...
            var l = this.lowerBound,
                u = this.upperBound;
            a.copy(l), b.set(u.x, l.y, l.z), c.set(u.x, u.y, l.z), d.set(l.x, u.y, u.z), e.set(u.x, l.y, l.z), f.set(l.x, u.y, l.z), g.set(l.x, l.y, u.z), h.copy(u)
        };
    ...
    7: [function (require, module, exports) {
        ...
        module.exports = ArrayCollisionMatrix, ArrayCollisionMatrix.prototype.get = function (i, j) {
            if (i = i.index, (j = j.index) > i) {
                var temp = j;
                j = i, i = temp
            }
    ...
    8: [function (require, module, exports) {
        var Body = require("../objects/Body"),
            Vec3 = require("../math/Vec3"),
            Quaternion = require("../math/Quaternion");
        require("../shapes/Shape"), require("../shapes/Plane");

        function Broadphase() {
            this.world = null, this.useBoundingBoxes = !1, this.dirty = !0
        }
        module.exports = Broadphase, Broadphase.prototype.collisionPairs = function (world, p1, p2) {
        ...
        Broadphase.prototype.doBoundingSphereBroadphase = function (bodyA, bodyB, pairs1, pairs2) {
            ...
            r.norm2() < boundingRadiusSum2 && (pairs1.push(bodyA), pairs2.push(bodyB))
        }, Broadphase.prototype.doBoundingBoxBroadphase = function (bodyA, bodyB, pairs1, pairs2) {
            bodyA.aabbNeedsUpdate && bodyA.computeAABB(), bodyB.aabbNeedsUpdate && bodyB.computeAABB(), bodyA.aabb.overlaps(bodyB.aabb) && (pairs1.push(bodyA), pairs2.push(bodyB))
        };
        ...
        Broadphase.prototype.makePairsUnique = function (pairs1, pairs2) {
            for (var t = Broadphase_makePairsUnique_temp, p1 = Broadphase_makePairsUnique_p1, p2 = Broadphase_makePairsUnique_p2, N = pairs1.length, i = 0; i !== N; i++) p1[i] = pairs1[i], p2[i] = pairs2[i];
            pairs1.length = 0, pairs2.length = 0;
            for (i = 0; i !== N; i++) {
                var id1 = p1[i].id,
                    id2 = p2[i].id;
                t[key = id1 < id2 ? id1 + "," + id2 : id2 + "," + id1] = i, t.keys.push(key)
            }
            for (i = 0; i !== t.keys.length; i++) {
                var key, pairIndex = t[key = t.keys.pop()];
    ...
    9: [function (require, module, exports) {
        ...
        function GridBroadphase(aabbMin, aabbMax, nx, ny, nz) {
            Broadphase.apply(this), this.nx = nx || 10, this.ny = ny || 10, this.nz = nz || 10, this.aabbMin = aabbMin || new Vec3(100, 100, 100), this.aabbMax = aabbMax || new Vec3(-100, -100, -100);
        ...
        GridBroadphase.prototype.collisionPairs = function (world, pairs1, pairs2) {
            ...
            function addBoxToBins(x0, y0, z0, x1, y1, z1, bi) {
                ...
                xoff0 < 0 ? xoff0 = 0 : xoff0 >= nx && (xoff0 = nx - 1), yoff0 < 0 ? yoff0 = 0 : yoff0 >= ny && (yoff0 = ny - 1), zoff0 < 0 ? zoff0 = 0 : zoff0 >= nz && (zoff0 = nz - 1), xoff1 < 0 ? xoff1 = 0 : xoff1 >= nx && (xoff1 = nx - 1), yoff1 < 0 ? yoff1 = 0 : yoff1 >= ny && (yoff1 = ny - 1), zoff1 < 0 ? zoff1 = 0 : zoff1 >= nz && (zoff1 = nz - 1), yoff0 *= ystep, zoff0 *= zstep, xoff1 *= xstep, yoff1 *= ystep, zoff1 *= zstep;
    ...
    10: [function (require, module, exports) {
        ...
        NaiveBroadphase.prototype = new Broadphase, NaiveBroadphase.prototype.constructor = NaiveBroadphase, NaiveBroadphase.prototype.collisionPairs = function (world, pairs1, pairs2) {
            var i, j, bi, bj, bodies = world.bodies,
                n = bodies.length;
            for (i = 0; i !== n; i++)
                for (j = 0; j !== i; j++) bi = bodies[i], bj = bodies[j], this.needBroadphaseCollision(bi, bj) && this.intersectionTest(bi, bj, pairs1, pairs2)
        };
        new AABB;
    ...
    11: [function (require, module, exports) {
        ...
        module.exports = ObjectCollisionMatrix, ObjectCollisionMatrix.prototype.get = function (i, j) {
            if (i = i.id, (j = j.id) > i) {
                var temp = j;
                j = i, i = temp
            }
    ...
    12: [function (require, module, exports) {
        ...
        module.exports = OverlapKeeper, OverlapKeeper.prototype.getKey = function (i, j) {
            if (j < i) {
                var temp = j;
                j = i, i = temp
            }
            ...
            if (key !== current[index]) {
                for (j = current.length - 1; j >= index; j--) current[j + 1] = current[j];
                current[index] = key
            }
    ...
    13: [function (require, module, exports) {
        ...
        Ray.prototype.intersectBody = function (body, result) {
            ...
            if ((!checkCollisionResponse || body.collisionResponse) && 0 != (this.collisionFilterGroup & body.collisionFilterMask) && 0 != (body.collisionFilterGroup & this.collisionFilterMask))
                for (var xi = intersectBody_xi, qi = intersectBody_qi, i = 0, N = body.shapes.length; i < N; i++) {
                    ...
                    if ((!checkCollisionResponse || shape.collisionResponse) && (body.quaternion.mult(body.shapeOrientations[i], qi), body.quaternion.vmult(body.shapeOffsets[i], xi), xi.vadd(body.position, xi), this.intersectShape(shape, qi, xi, body), this.result._shouldStop)) break
                }
            ...
            if (!(function (from, direction, position) {
                ...
                }(this.from, this._direction, position) > shape.boundingSphereRadius)) {
        ...
        Ray.prototype.intersectBox = function (shape, quat, position, body, reportedShape) {
        ...
        }, Ray.prototype[Shape.types.BOX] = Ray.prototype.intersectBox, Ray.prototype.intersectPlane = function (shape, quat, position, body, reportedShape) {
            var from = this.from,
                to = this.to,
            ...
            if (to.vsub(position, len), !(planeToFrom * len.dot(worldNormal) > 0 || from.distanceTo(to) < planeToFrom)) {
                ...
                if (!(Math.abs(n_dot_dir) < this.precision)) {
                    ...
                    direction.scale(t, dir_scaled_with_t), from.vadd(dir_scaled_with_t, hitPointWorld), this.reportIntersection(worldNormal, hitPointWorld, reportedShape, body, -1)
                }
            }
        }, Ray.prototype[Shape.types.PLANE] = Ray.prototype.intersectPlane, Ray.prototype.getAABB = function (result) {
            var to = this.to,
                from = this.from;
            result.lowerBound.x = Math.min(to.x, from.x), result.lowerBound.y = Math.min(to.y, from.y), result.lowerBound.z = Math.min(to.z, from.z), result.upperBound.x = Math.max(to.x, from.x), result.upperBound.y = Math.max(to.y, from.y), result.upperBound.z = Math.max(to.z, from.z)
        };
        ...
        Ray.prototype.intersectHeightfield = function (shape, quat, position, body, reportedShape) {
            ...
            localRay.from.copy(this.from), localRay.to.copy(this.to), Transform.pointToLocalFrame(position, quat, localRay.from, localRay.from), Transform.pointToLocalFrame(position, quat, localRay.to, localRay.to), localRay._updateDirection();
            var iMinX, iMinY, iMaxX, iMaxY, index = intersectHeightfield_index;
            iMinX = iMinY = 0, iMaxX = iMaxY = shape.data.length - 1;
            var aabb = new AABB;
            localRay.getAABB(aabb), shape.getIndexOfPosition(aabb.lowerBound.x, aabb.lowerBound.y, index, !0), iMinX = Math.max(iMinX, index[0]), iMinY = Math.max(iMinY, index[1]), shape.getIndexOfPosition(aabb.upperBound.x, aabb.upperBound.y, index, !0), iMaxX = Math.min(iMaxX, index[0] + 1), iMaxY = Math.min(iMaxY, index[1] + 1);
            for (var i = iMinX; i < iMaxX; i++)
                for (var j = iMinY; j < iMaxY; j++) {
                    if (this.result._shouldStop) return;
                    if (shape.getAabbAtIndex(i, j, aabb), aabb.overlapsRay(localRay)) {
                        if (shape.getConvexTrianglePillar(i, j, !1), Transform.pointToWorldFrame(position, quat, shape.pillarOffset, worldPillarOffset), this.intersectConvex(shape.pillarConvex, quat, worldPillarOffset, body, reportedShape, intersectConvexOptions), this.result._shouldStop) return;
                        shape.getConvexTrianglePillar(i, j, !0), Transform.pointToWorldFrame(position, quat, shape.pillarOffset, worldPillarOffset), this.intersectConvex(shape.pillarConvex, quat, worldPillarOffset, body, reportedShape, intersectConvexOptions)
                    }
                }
        ...
        Ray.prototype.intersectSphere = function (shape, quat, position, body, reportedShape) {
            ...
            if (!(delta < 0))
                if (0 === delta) from.lerp(to, delta, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1);
                else {
                    var d1 = (-b - Math.sqrt(delta)) / (2 * a),
                        d2 = (-b + Math.sqrt(delta)) / (2 * a);
                    if (d1 >= 0 && d1 <= 1 && (from.lerp(to, d1, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1)), this.result._shouldStop) return;
                    d2 >= 0 && d2 <= 1 && (from.lerp(to, d2, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1))
                }
        ...
        Ray.prototype.intersectConvex = function (shape, quat, position, body, reportedShape, options) {
            for (var normal = intersectConvex_normal, vector = intersectConvex_vector, faceList = options && options.faceList || null, faces = shape.faces, vertices = shape.vertices, normals = shape.faceNormals, direction = this._direction, from = this.from, to = this.to, fromToDistance = from.distanceTo(to), Nfaces = faceList ? faceList.length : faces.length, result = this.result, j = 0; !result._shouldStop && j < Nfaces; j++) {
                var fi = faceList ? faceList[j] : j,
                    ...
                    q = quat,
                    x = position;
                vector.copy(vertices[face[0]]), q.vmult(vector, vector), vector.vadd(x, vector), vector.vsub(from, vector), q.vmult(faceNormal, normal);
                var dot = direction.dot(normal);
                if (!(Math.abs(dot) < this.precision)) {
                    var scalar = normal.dot(vector) / dot;
                    if (!(scalar < 0)) {
                        direction.mult(scalar, intersectPoint), intersectPoint.vadd(from, intersectPoint), a.copy(vertices[face[0]]), q.vmult(a, a), x.vadd(a, a);
                        for (var i = 1; !result._shouldStop && i < face.length - 1; i++) {
                            b.copy(vertices[face[i]]), c.copy(vertices[face[i + 1]]), q.vmult(b, b), q.vmult(c, c), x.vadd(b, b), x.vadd(c, c);
        ...
        Ray.prototype.intersectTrimesh = function (mesh, quat, position, body, reportedShape, options) {
            var normal = intersectTrimesh_normal,
                ...
                indices = (options && options.faceList, mesh.indices),
                from = (mesh.vertices, mesh.faceNormals, this.from),
                to = this.to,
                direction = this._direction;
            treeTransform.position.copy(position), treeTransform.quaternion.copy(quat), Transform.vectorToLocalFrame(position, quat, direction, localDirection), Transform.pointToLocalFrame(position, quat, from, localFrom), Transform.pointToLocalFrame(position, quat, to, localTo), localTo.x *= mesh.scale.x, localTo.y *= mesh.scale.y, localTo.z *= mesh.scale.z, localFrom.x *= mesh.scale.x, localFrom.y *= mesh.scale.y, localFrom.z *= mesh.scale.z, localTo.vsub(localFrom, localDirection), localDirection.normalize();
            var fromToDistanceSquared = localFrom.distanceSquared(localTo);
            mesh.tree.rayQuery(this, treeTransform, triangles);
            for (var i = 0, N = triangles.length; !this.result._shouldStop && i !== N; i++) {
                var trianglesIndex = triangles[i];
                mesh.getNormal(trianglesIndex, normal), mesh.getVertex(indices[3 * trianglesIndex], a), a.vsub(localFrom, vector);
                var dot = localDirection.dot(normal),
                    scalar = normal.dot(vector) / dot;
                if (!(scalar < 0)) {
                    localDirection.scale(scalar, intersectPoint), intersectPoint.vadd(localFrom, intersectPoint), mesh.getVertex(indices[3 * trianglesIndex + 1], b), mesh.getVertex(indices[3 * trianglesIndex + 2], c);
            ...
            var from = this.from,
                ...
                result = this.result;
            if (!(this.skipBackfaces && normal.dot(this._direction) > 0)) switch (result.hitFaceIndex = void 0 !== hitFaceIndex ? hitFaceIndex : -1, this.mode) {
                case Ray.ALL:
                    this.hasHit = !0, result.set(from, to, normal, hitPointWorld, shape, body, distance), result.hasHit = !0, this.callback(result);
                    break;
                case Ray.CLOSEST:
                    (distance < result.distance || !result.hasHit) && (this.hasHit = !0, result.hasHit = !0, result.set(from, to, normal, hitPointWorld, shape, body, distance));
                    break;
                case Ray.ANY:
                    this.hasHit = !0, result.hasHit = !0, result.set(from, to, normal, hitPointWorld, shape, body, distance), result._shouldStop = !0
            }
        };
        var v0 = new Vec3,
            intersect = new Vec3
    ...
    14: [function (require, module, exports) {
        ...
        function RaycastResult() {
            this.rayFromWorld = new Vec3, this.rayToWorld = new Vec3, this.hitNormalWorld = new Vec3, this.hitPointWorld = new Vec3, this.hasHit = !1, this.shape = null, this.body = null, this.hitFaceIndex = -1, this.distance = -1, this._shouldStop = !1
        }
        module.exports = RaycastResult, RaycastResult.prototype.reset = function () {
            ...
            this.rayFromWorld.copy(rayFromWorld), this.rayToWorld.copy(rayToWorld), this.hitNormalWorld.copy(hitNormalWorld), this.hitPointWorld.copy(hitPointWorld), this.shape = shape, this.body = body, this.distance = distance
        }
    }, {
        "../math/Vec3": 34
    }],
    15: [function (require, module, exports) {
        ...
        function SAPBroadphase(world) {
            ...
            this._addBodyHandler = function (e) {
                ...
                var idx = axisList.indexOf(e.body); - 1 !== idx && axisList.splice(idx, 1)
            }, world && this.setWorld(world)
        }
        module.exports = SAPBroadphase, SAPBroadphase.prototype = new Broadphase, SAPBroadphase.prototype.setWorld = function (world) {
            this.axisList.length = 0;
            for (var i = 0; i < world.bodies.length; i++) this.axisList.push(world.bodies[i]);
            world.removeEventListener("addBody", this._addBodyHandler), world.removeEventListener("removeBody", this._removeBodyHandler), world.addEventListener("addBody", this._addBodyHandler), world.addEventListener("removeBody", this._removeBodyHandler), this.world = world, this.dirty = !0
        }, SAPBroadphase.insertionSortX = function (a) {
            for (var i = 1, l = a.length; i < l; i++) {
                for (var v = a[i], j = i - 1; j >= 0 && !(a[j].aabb.lowerBound.x <= v.aabb.lowerBound.x); j--) a[j + 1] = a[j];
                a[j + 1] = v
            }
            return a
        }, SAPBroadphase.insertionSortY = function (a) {
            for (var i = 1, l = a.length; i < l; i++) {
                for (var v = a[i], j = i - 1; j >= 0 && !(a[j].aabb.lowerBound.y <= v.aabb.lowerBound.y); j--) a[j + 1] = a[j];
                a[j + 1] = v
            }
            return a
        }, SAPBroadphase.insertionSortZ = function (a) {
            for (var i = 1, l = a.length; i < l; i++) {
                for (var v = a[i], j = i - 1; j >= 0 && !(a[j].aabb.lowerBound.z <= v.aabb.lowerBound.z); j--) a[j + 1] = a[j];
                a[j + 1] = v
            }
            return a
        }, SAPBroadphase.prototype.collisionPairs = function (world, p1, p2) {
            var i, j, bodies = this.axisList,
                N = bodies.length,
            ...
            var biPos, bjPos;
            0 === axisIndex ? (biPos = bi.position.x, bjPos = bj.position.x) : 1 === axisIndex ? (biPos = bi.position.y, bjPos = bj.position.y) : 2 === axisIndex && (biPos = bi.position.z, bjPos = bj.position.z);
            ...
            for (var axisList = this.axisList, i = (aabb.lowerBound[axis], aabb.upperBound[axis], 0); i < axisList.length; i++) {
                var b = axisList[i];
                b.aabbNeedsUpdate && b.computeAABB(), b.aabb.overlaps(aabb) && result.push(b)
            }
            return result
    ...
    16: [function (require, module, exports) {
        ...
        var PointToPointConstraint = require("./PointToPointConstraint"),
            ...
            RotationalEquation = require("../equations/RotationalEquation"),
            Vec3 = (require("../equations/ContactEquation"), require("../math/Vec3"));
        ...
        function ConeTwistConstraint(bodyA, bodyB, options) {
            ...
            this.axisA = options.axisA ? options.axisA.clone() : new Vec3, this.axisB = options.axisB ? options.axisB.clone() : new Vec3, PointToPointConstraint.call(this, bodyA, pivotA, bodyB, pivotB, maxForce), this.collideConnected = !!options.collideConnected, this.angle = void 0 !== options.angle ? options.angle : 0;
            var c = this.coneEquation = new ConeEquation(bodyA, bodyB, options),
                t = this.twistEquation = new RotationalEquation(bodyA, bodyB, options);
            this.twistAngle = void 0 !== options.twistAngle ? options.twistAngle : 0, c.maxForce = 0, c.minForce = -maxForce, t.maxForce = 0, t.minForce = -maxForce, this.equations.push(c, t)
        }
        ...
        ConeTwistConstraint.prototype.update = function () {
            ...
            PointToPointConstraint.prototype.update.call(this), bodyA.vectorToWorldFrame(this.axisA, cone.axisA), bodyB.vectorToWorldFrame(this.axisB, cone.axisB), this.axisA.tangents(twist.axisA, twist.axisA), bodyA.vectorToWorldFrame(twist.axisA, twist.axisA), this.axisB.tangents(twist.axisB, twist.axisB), bodyB.vectorToWorldFrame(twist.axisB, twist.axisB), cone.angle = this.angle, twist.maxAngle = this.twistAngle
        }
    }, {
        "../equations/ConeEquation": 22,
        "../equations/ContactEquation": 23,
        "../equations/RotationalEquation": 26,
        "../math/Vec3": 34,
        "./Constraint": 17,
        "./PointToPointConstraint": 21
    }],
    17: [function (require, module, exports) {
        ...
        function Constraint(bodyA, bodyB, options) {
            options = Utils.defaults(options, {
                collideConnected: !0,
                wakeUpBodies: !0
            }), this.equations = [], this.bodyA = bodyA, this.bodyB = bodyB, this.id = Constraint.idCounter++, this.collideConnected = options.collideConnected, options.wakeUpBodies && (bodyA && bodyA.wakeUp(), bodyB && bodyB.wakeUp())
        }
    ...
    18: [function (require, module, exports) {
        ...
        function DistanceConstraint(bodyA, bodyB, distance, maxForce) {
            Constraint.call(this, bodyA, bodyB), void 0 === distance && (distance = bodyA.position.distanceTo(bodyB.position)), void 0 === maxForce && (maxForce = 1e6), this.distance = distance;
            var eq = this.distanceEquation = new ContactEquation(bodyA, bodyB);
            this.equations.push(eq), eq.minForce = -maxForce, eq.maxForce = maxForce
        }
        DistanceConstraint.prototype = new Constraint, DistanceConstraint.prototype.update = function () {
            var bodyA = this.bodyA,
                bodyB = this.bodyB,
                eq = this.distanceEquation,
                halfDist = .5 * this.distance,
                normal = eq.ni;
            bodyB.position.vsub(bodyA.position, normal), normal.normalize(), normal.mult(halfDist, eq.ri), normal.mult(-halfDist, eq.rj)
        }
    }, {
        "../equations/ContactEquation": 23,
        "./Constraint": 17
    ...
    19: [function (require, module, exports) {
        ...
        function HingeConstraint(bodyA, bodyB, options) {
            var maxForce = void 0 !== (options = options || {}).maxForce ? options.maxForce : 1e6,
                pivotA = options.pivotA ? options.pivotA.clone() : new Vec3,
                pivotB = options.pivotB ? options.pivotB.clone() : new Vec3;
            PointToPointConstraint.call(this, bodyA, pivotA, bodyB, pivotB, maxForce), (this.axisA = options.axisA ? options.axisA.clone() : new Vec3(1, 0, 0)).normalize(), (this.axisB = options.axisB ? options.axisB.clone() : new Vec3(1, 0, 0)).normalize();
        ...
        HingeConstraint.prototype = new PointToPointConstraint, HingeConstraint.constructor = HingeConstraint, HingeConstraint.prototype.enableMotor = function () {
    ...
    20: [function (require, module, exports) {
        ...
        var PointToPointConstraint = require("./PointToPointConstraint"),
            RotationalEquation = require("../equations/RotationalEquation"),
            Vec3 = (require("../equations/RotationalMotorEquation"), require("../equations/ContactEquation"), require("../math/Vec3"));
        ...
        function LockConstraint(bodyA, bodyB, options) {
            var maxForce = void 0 !== (options = options || {}).maxForce ? options.maxForce : 1e6,
                ...
                pivotB = new Vec3,
                halfWay = new Vec3;
            bodyA.position.vadd(bodyB.position, halfWay), halfWay.scale(.5, halfWay), bodyB.pointToLocalFrame(halfWay, pivotB), bodyA.pointToLocalFrame(halfWay, pivotA), PointToPointConstraint.call(this, bodyA, pivotA, bodyB, pivotB, maxForce), this.xA = bodyA.vectorToLocalFrame(Vec3.UNIT_X), this.xB = bodyB.vectorToLocalFrame(Vec3.UNIT_X), this.yA = bodyA.vectorToLocalFrame(Vec3.UNIT_Y), this.yB = bodyB.vectorToLocalFrame(Vec3.UNIT_Y), this.zA = bodyA.vectorToLocalFrame(Vec3.UNIT_Z), this.zB = bodyB.vectorToLocalFrame(Vec3.UNIT_Z);
            var r1 = this.rotationalEquation1 = new RotationalEquation(bodyA, bodyB, options),
                r2 = this.rotationalEquation2 = new RotationalEquation(bodyA, bodyB, options),
    ...
    21: [function (require, module, exports) {
        ...
        function PointToPointConstraint(bodyA, pivotA, bodyB, pivotB, maxForce) {
            Constraint.call(this, bodyA, bodyB), maxForce = void 0 !== maxForce ? maxForce : 1e6, this.pivotA = pivotA ? pivotA.clone() : new Vec3, this.pivotB = pivotB ? pivotB.clone() : new Vec3;
            var x = this.equationX = new ContactEquation(bodyA, bodyB),
                y = this.equationY = new ContactEquation(bodyA, bodyB),
                z = this.equationZ = new ContactEquation(bodyA, bodyB);
            this.equations.push(x, y, z), x.minForce = y.minForce = z.minForce = -maxForce, x.maxForce = y.maxForce = z.maxForce = maxForce, x.ni.set(1, 0, 0), y.ni.set(0, 1, 0), z.ni.set(0, 0, 1)
        }
        PointToPointConstraint.prototype = new Constraint, PointToPointConstraint.prototype.update = function () {
            var bodyA = this.bodyA,
                bodyB = this.bodyB,
                x = this.equationX,
                y = this.equationY,
                z = this.equationZ;
            bodyA.quaternion.vmult(this.pivotA, x.ri), bodyB.quaternion.vmult(this.pivotB, x.rj), y.ri.copy(x.ri), y.rj.copy(x.rj), z.ri.copy(x.ri), z.rj.copy(x.rj)
        }
    }, {
        "../equations/ContactEquation": 23,
        "../math/Vec3": 34,
    ...
    22: [function (require, module, exports) {
        ...
        var Vec3 = require("../math/Vec3"),
            Equation = (require("../math/Mat3"), require("./Equation"));

        function ConeEquation(bodyA, bodyB, options) {
            var maxForce = void 0 !== (options = options || {}).maxForce ? options.maxForce : 1e6;
            Equation.call(this, bodyA, bodyB, -maxForce, maxForce), this.axisA = options.axisA ? options.axisA.clone() : new Vec3(1, 0, 0), this.axisB = options.axisB ? options.axisB.clone() : new Vec3(0, 1, 0), this.angle = void 0 !== options.angle ? options.angle : 0
        }
        ConeEquation.prototype = new Equation, ConeEquation.prototype.constructor = ConeEquation;
        ...
        ConeEquation.prototype.computeB = function (h) {
            ...
            return ni.cross(nj, nixnj), nj.cross(ni, njxni), GA.rotational.copy(njxni), GB.rotational.copy(nixnj), -(Math.cos(this.angle) - ni.dot(nj)) * a - this.computeGW() * b - h * this.computeGiMf()
        }
    }, {
        "../math/Mat3": 31,
        "../math/Vec3": 34,
    ...
    23: [function (require, module, exports) {
        ...
        function ContactEquation(bodyA, bodyB, maxForce) {
            maxForce = void 0 !== maxForce ? maxForce : 1e6, Equation.call(this, bodyA, bodyB, 0, maxForce), this.restitution = 0, this.ri = new Vec3, this.rj = new Vec3, this.ni = new Vec3
        }
        ContactEquation.prototype = new Equation, ContactEquation.prototype.constructor = ContactEquation;
        ...
        ContactEquation.prototype.computeB = function (h) {
            var a = this.a,
                ...
                penetrationVec = (bj.force, bj.torque, ContactEquation_computeB_temp3),
                GA = this.jacobianElementA,
                GB = this.jacobianElementB,
                n = this.ni;
            ri.cross(n, rixn), rj.cross(n, rjxn), n.negate(GA.spatial), rixn.negate(GA.rotational), GB.spatial.copy(n), GB.rotational.copy(rjxn), penetrationVec.copy(bj.position), penetrationVec.vadd(rj, penetrationVec), penetrationVec.vsub(bi.position, penetrationVec), penetrationVec.vsub(ri, penetrationVec);
        ...
        ContactEquation.prototype.getImpactVelocityAlongNormal = function () {
            ...
            return this.bi.position.vadd(this.ri, xi), this.bj.position.vadd(this.rj, xj), this.bi.getVelocityAtWorldPoint(xi, vi), this.bj.getVelocityAtWorldPoint(xj, vj), vi.vsub(vj, relVel), this.ni.dot(relVel)
        }
    }, {
        "../math/Mat3": 31,
        "../math/Vec3": 34,
    ...
    24: [function (require, module, exports) {
        ...
        function Equation(bi, bj, minForce, maxForce) {
            this.id = Equation.id++, this.minForce = void 0 === minForce ? -1e6 : minForce, this.maxForce = void 0 === maxForce ? 1e6 : maxForce, this.bi = bi, this.bj = bj, this.a = 0, this.b = 0, this.eps = 0, this.jacobianElementA = new JacobianElement, this.jacobianElementB = new JacobianElement, this.enabled = !0, this.multiplier = 0, this.setSpookParams(1e7, 4, 1 / 60)
        }
        Equation.prototype.constructor = Equation, Equation.id = 0, Equation.prototype.setSpookParams = function (stiffness, relaxation, timeStep) {
            var d = relaxation,
                k = stiffness,
                h = timeStep;
        ...
        Equation.prototype.computeGiMf = function () {
            ...
            return fi.scale(invMassi, iMfi), fj.scale(invMassj, iMfj), bi.invInertiaWorldSolve.vmult(ti, invIi_vmult_taui), bj.invInertiaWorldSolve.vmult(tj, invIj_vmult_tauj), GA.multiplyVectors(iMfi, invIi_vmult_taui) + GB.multiplyVectors(iMfj, invIj_vmult_tauj)
        };
        var tmp = new Vec3;
        Equation.prototype.computeGiMGt = function () {
            ...
            return invIi.vmult(GA.rotational, tmp), result += tmp.dot(GA.rotational), invIj.vmult(GB.rotational, tmp), result += tmp.dot(GB.rotational)
        };
        ...
        Equation.prototype.addToWlambda = function (deltalambda) {
            ...
            bi.vlambda.addScaledVector(bi.invMassSolve * deltalambda, GA.spatial, bi.vlambda), bj.vlambda.addScaledVector(bj.invMassSolve * deltalambda, GB.spatial, bj.vlambda), bi.invInertiaWorldSolve.vmult(GA.rotational, temp), bi.wlambda.addScaledVector(deltalambda, temp, bi.wlambda), bj.invInertiaWorldSolve.vmult(GB.rotational, temp), bj.wlambda.addScaledVector(deltalambda, temp, bj.wlambda)
        }, Equation.prototype.computeC = function () {
            return this.computeGiMGt() + this.eps
        }
    }, {
        "../math/JacobianElement": 30,
        "../math/Vec3": 34
    }],
    25: [function (require, module, exports) {
        ...
        function FrictionEquation(bodyA, bodyB, slipForce) {
            Equation.call(this, bodyA, bodyB, -slipForce, slipForce), this.ri = new Vec3, this.rj = new Vec3, this.t = new Vec3
        }
        FrictionEquation.prototype = new Equation, FrictionEquation.prototype.constructor = FrictionEquation;
        ...
        FrictionEquation.prototype.computeB = function (h) {
            ...
            var GA = this.jacobianElementA,
                GB = this.jacobianElementB;
            return t.negate(GA.spatial), rixt.negate(GA.rotational), GB.spatial.copy(t), GB.rotational.copy(rjxt), -this.computeGW() * b - h * this.computeGiMf()
        }
    }, {
        "../math/Mat3": 31,
        "../math/Vec3": 34,
    ...
    26: [function (require, module, exports) {
        ...
        function RotationalEquation(bodyA, bodyB, options) {
            var maxForce = void 0 !== (options = options || {}).maxForce ? options.maxForce : 1e6;
            Equation.call(this, bodyA, bodyB, -maxForce, maxForce), this.axisA = options.axisA ? options.axisA.clone() : new Vec3(1, 0, 0), this.axisB = options.axisB ? options.axisB.clone() : new Vec3(0, 1, 0), this.maxAngle = Math.PI / 2
        }
        RotationalEquation.prototype = new Equation, RotationalEquation.prototype.constructor = RotationalEquation;
        var tmpVec1 = new Vec3,
            tmpVec2 = new Vec3;
        RotationalEquation.prototype.computeB = function (h) {
            var a = this.a,
                ...
                GA = this.jacobianElementA,
                GB = this.jacobianElementB;
            return ni.cross(nj, nixnj), nj.cross(ni, njxni), GA.rotational.copy(njxni), GB.rotational.copy(nixnj), -(Math.cos(this.maxAngle) - ni.dot(nj)) * a - this.computeGW() * b - h * this.computeGiMf()
        }
    }, {
        "../math/Mat3": 31,
        "../math/Vec3": 34,
    ...
    27: [function (require, module, exports) {
        ...
        function RotationalMotorEquation(bodyA, bodyB, maxForce) {
            maxForce = void 0 !== maxForce ? maxForce : 1e6, Equation.call(this, bodyA, bodyB, -maxForce, maxForce), this.axisA = new Vec3, this.axisB = new Vec3, this.targetVelocity = 0
        }
        RotationalMotorEquation.prototype = new Equation, RotationalMotorEquation.prototype.constructor = RotationalMotorEquation, RotationalMotorEquation.prototype.computeB = function (h) {
            this.a;
            var b = this.b,
    ...
    28: [function (require, module, exports) {
        ...
        function ContactMaterial(m1, m2, options) {
            ...
            }), this.id = ContactMaterial.idCounter++, this.materials = [m1, m2], this.friction = options.friction, this.restitution = options.restitution, this.contactEquationStiffness = options.contactEquationStiffness, this.contactEquationRelaxation = options.contactEquationRelaxation, this.frictionEquationStiffness = options.frictionEquationStiffness, this.frictionEquationRelaxation = options.frictionEquationRelaxation
        }
    ...
    29: [function (require, module, exports) {
        function Material(options) {
            var name = "";
            "string" == typeof (options = options || {}) ? (name = options, options = {}) : "object" == typeof options && (name = ""), this.name = name, this.id = Material.idCounter++, this.friction = void 0 !== options.friction ? options.friction : -1, this.restitution = void 0 !== options.restitution ? options.restitution : -1
        }
    ...
    31: [function (require, module, exports) {
        ...
        Mat3.prototype.identity = function () {
            ...
            var e = this.elements,
                ...
                y = v.y,
                z = v.z;
            return target.x = e[0] * x + e[1] * y + e[2] * z, target.y = e[3] * x + e[4] * y + e[5] * z, target.z = e[6] * x + e[7] * y + e[8] * z, target
            ...
            for (var e = this.elements, t = target.elements, i = 0; 3 !== i; i++) t[3 * i + 0] = v.x * e[3 * i + 0], t[3 * i + 1] = v.y * e[3 * i + 1], t[3 * i + 2] = v.z * e[3 * i + 2];
            return target
        }, Mat3.prototype.solve = function (b, target) {
            target = target || new Vec3;
            for (var j, eqns = [], i = 0; i < 12; i++) eqns.push(0);
            for (i = 0; i < 3; i++)
                for (j = 0; j < 3; j++) eqns[i + 4 * j] = this.elements[i + 3 * j];
            ...
            if (target.z = eqns[11] / eqns[10], target.y = (eqns[7] - eqns[6] * target.z) / eqns[5], target.x = (eqns[3] - eqns[2] * target.z - eqns[1] * target.y) / eqns[0], isNaN(target.x) || isNaN(target.y) || isNaN(target.z) || target.x === 1 / 0 || target.y === 1 / 0 || target.z === 1 / 0) throw "Could not solve equation! Got x=[" + target.toString() + "], b=[" + b.toString() + "], A=[" + this.toString() + "]";
            return target
            ...
            for (i = 0; i < 3; i++)
                for (j = 0; j < 3; j++) eqns[i + 6 * j] = this.elements[i + 3 * j];
            eqns[3] = 1, eqns[9] = 0, eqns[15] = 0, eqns[4] = 0, eqns[10] = 1, eqns[16] = 0, eqns[5] = 0, eqns[11] = 0, eqns[17] = 1;
            var np, p, n = 3,
                k = n;
            do {
                if (0 === eqns[(i = k - n) + 6 * i])
            ...
            var x = q.x,
                ...
                wz = w * z2,
                e = this.elements;
            return e[0] = 1 - (yy + zz), e[1] = xy - wz, e[2] = xz + wy, e[3] = xy + wz, e[4] = 1 - (xx + zz), e[5] = yz - wx, e[6] = xz - wy, e[7] = yz + wx, e[8] = 1 - (xx + yy), this
    ...
    32: [function (require, module, exports) {
        ...
        function Quaternion(x, y, z, w) {
            this.x = void 0 !== x ? x : 0, this.y = void 0 !== y ? y : 0, this.z = void 0 !== z ? z : 0, this.w = void 0 !== w ? w : 1
        }
        Quaternion.prototype.set = function (x, y, z, w) {
            ...
            return this.x = axis.x * s, this.y = axis.y * s, this.z = axis.z * s, this.w = Math.cos(.5 * angle), this
        }, Quaternion.prototype.toAxisAngle = function (targetAxis) {
            targetAxis = targetAxis || new Vec3, this.normalize();
            var angle = 2 * Math.acos(this.w),
                s = Math.sqrt(1 - this.w * this.w);
            return s < .001 ? (targetAxis.x = this.x, targetAxis.y = this.y, targetAxis.z = this.z) : (targetAxis.x = this.x / s, targetAxis.y = this.y / s, targetAxis.z = this.z / s), [targetAxis, angle]
        };
        var sfv_t1 = new Vec3,
            sfv_t2 = new Vec3;
        Quaternion.prototype.setFromVectors = function (u, v) {
            if (u.isAntiparallelTo(v)) {
                ...
                var a = u.cross(v);
                this.x = a.x, this.y = a.y, this.z = a.z, this.w = Math.sqrt(Math.pow(u.norm(), 2) * Math.pow(v.norm(), 2)) + u.dot(v), this.normalize()
            }
            return this
        };
        ...
        Quaternion.prototype.mult = function (q, target) {
            ...
            var ax = this.x,
                ...
                bz = q.z,
                bw = q.w;
            return target.x = ax * bw + aw * bx + ay * bz - az * by, target.y = ay * bw + aw * by + az * bx - ax * bz, target.z = az * bw + aw * bz + ax * by - ay * bx, target.w = aw * bw - ax * bx - ay * by - az * bz, target
            ...
            return target.x *= inorm2, target.y *= inorm2, target.z *= inorm2, target.w *= inorm2, target
        }, Quaternion.prototype.conjugate = function (target) {
            return (target = target || new Quaternion).x = -this.x, target.y = -this.y, target.z = -this.z, target.w = this.w, target
        }, Quaternion.prototype.normalize = function () {
            var l = Math.sqrt(this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w);
            return 0 === l ? (this.x = 0, this.y = 0, this.z = 0, this.w = 0) : (l = 1 / l, this.x *= l, this.y *= l, this.z *= l, this.w *= l), this
        }, Quaternion.prototype.normalizeFast = function () {
            var f = (3 - (this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w)) / 2;
            return 0 === f ? (this.x = 0, this.y = 0, this.z = 0, this.w = 0) : (this.x *= f, this.y *= f, this.z *= f, this.w *= f), this
            ...
            var x = v.x,
                ...
                iz = qw * z + qx * y - qy * x,
                iw = -qx * x - qy * y - qz * z;
            return target.x = ix * qw + iw * -qx + iy * -qz - iz * -qy, target.y = iy * qw + iw * -qy + iz * -qx - ix * -qz, target.z = iz * qw + iw * -qz + ix * -qy - iy * -qx, target
            ...
            switch (order) {
                case "YZX":
                    var test = x * y + z * w;
                    if (test > .499 && (heading = 2 * Math.atan2(x, w), attitude = Math.PI / 2, bank = 0), test < -.499 && (heading = -2 * Math.atan2(x, w), attitude = -Math.PI / 2, bank = 0), isNaN(heading)) {
                        var sqx = x * x,
                            sqy = y * y,
                            sqz = z * z;
                        heading = Math.atan2(2 * y * w - 2 * x * z, 1 - 2 * sqy - 2 * sqz), attitude = Math.asin(2 * test), bank = Math.atan2(2 * x * w - 2 * y * z, 1 - 2 * sqx - 2 * sqz)
                    }
                    break;
                default:
            ...
            var c1 = Math.cos(x / 2),
                ...
                s2 = Math.sin(y / 2),
                s3 = Math.sin(z / 2);
            return "XYZ" === order ? (this.x = s1 * c2 * c3 + c1 * s2 * s3, this.y = c1 * s2 * c3 - s1 * c2 * s3, this.z = c1 * c2 * s3 + s1 * s2 * c3, this.w = c1 * c2 * c3 - s1 * s2 * s3) : "YXZ" === order ? (this.x = s1 * c2 * c3 + c1 * s2 * s3, this.y = c1 * s2 * c3 - s1 * c2 * s3, this.z = c1 * c2 * s3 - s1 * s2 * c3, this.w = c1 * c2 * c3 + s1 * s2 * s3) : "ZXY" === order ? (this.x = s1 * c2 * c3 - c1 * s2 * s3, this.y = c1 * s2 * c3 + s1 * c2 * s3, this.z = c1 * c2 * s3 + s1 * s2 * c3, this.w = c1 * c2 * c3 - s1 * s2 * s3) : "ZYX" === order ? (this.x = s1 * c2 * c3 - c1 * s2 * s3, this.y = c1 * s2 * c3 + s1 * c2 * s3, this.z = c1 * c2 * s3 - s1 * s2 * c3, this.w = c1 * c2 * c3 + s1 * s2 * s3) : "YZX" === order ? (this.x = s1 * c2 * c3 + c1 * s2 * s3, this.y = c1 * s2 * c3 + s1 * c2 * s3, this.z = c1 * c2 * s3 - s1 * s2 * c3, this.w = c1 * c2 * c3 - s1 * s2 * s3) : "XZY" === order && (this.x = s1 * c2 * c3 - c1 * s2 * s3, this.y = c1 * s2 * c3 - s1 * c2 * s3, this.z = c1 * c2 * s3 + s1 * s2 * c3, this.w = c1 * c2 * c3 + s1 * s2 * s3), this
        }, Quaternion.prototype.clone = function () {
            return new Quaternion(this.x, this.y, this.z, this.w)
        }, Quaternion.prototype.slerp = function (toQuat, t, target) {
            target = target || new Quaternion;
            var omega, cosom, sinom, scale0, scale1, ax = this.x,
                ay = this.y,
                az = this.z,
                aw = this.w,
                bx = toQuat.x,
                ...
                bz = toQuat.z,
                bw = toQuat.w;
            return (cosom = ax * bx + ay * by + az * bz + aw * bw) < 0 && (cosom = -cosom, bx = -bx, by = -by, bz = -bz, bw = -bw), 1 - cosom > 1e-6 ? (omega = Math.acos(cosom), sinom = Math.sin(omega), scale0 = Math.sin((1 - t) * omega) / sinom, scale1 = Math.sin(t * omega) / sinom) : (scale0 = 1 - t, scale1 = t), target.x = scale0 * ax + scale1 * bx, target.y = scale0 * ay + scale1 * by, target.z = scale0 * az + scale1 * bz, target.w = scale0 * aw + scale1 * bw, target
            ...
            var ax = angularVelocity.x * angularFactor.x,
                ...
                bw = this.w,
                half_dt = .5 * dt;
            return target.x += half_dt * (ax * bw + ay * bz - az * by), target.y += half_dt * (ay * bw + az * bx - ax * bz), target.z += half_dt * (az * bw + ax * by - ay * bx), target.w += half_dt * (-ax * bx - ay * by - az * bz), target
        }
    }, {
        "./Vec3": 34
    }],
    33: [function (require, module, exports) {
        ...
        function Transform(options) {
            options = options || {}, this.position = new Vec3, options.position && this.position.copy(options.position), this.quaternion = new Quaternion, options.quaternion && this.quaternion.copy(options.quaternion)
        }
        module.exports = Transform;
        var tmpQuat = new Quaternion;
        Transform.pointToLocalFrame = function (position, quaternion, worldPoint, result) {
            result = result || new Vec3;
            return worldPoint.vsub(position, result), quaternion.conjugate(tmpQuat), tmpQuat.vmult(result, result), result
            ...
            result = result || new Vec3;
            return quaternion.w *= -1, quaternion.vmult(worldVector, result), quaternion.w *= -1, result
        }
    }, {
        "./Quaternion": 32,
        "./Vec3": 34
    ...
    34: [function (require, module, exports) {
        ...
        Vec3.ZERO = new Vec3(0, 0, 0), Vec3.UNIT_X = new Vec3(1, 0, 0), Vec3.UNIT_Y = new Vec3(0, 1, 0), Vec3.UNIT_Z = new Vec3(0, 0, 1), Vec3.prototype.cross = function (v, target) {
            var vx = v.x,
                vy = v.y,
                vz = v.z,
                x = this.x,
                y = this.y,
                z = this.z;
            return (target = target || new Vec3).x = y * vz - z * vy, target.y = z * vx - x * vz, target.z = x * vy - y * vx, target
            ...
            return ninv > 0 ? (ninv = 1 / ninv, target.x = x * ninv, target.y = y * ninv, target.z = z * ninv) : (target.x = 1, target.y = 0, target.z = 0), target
        ...
        }, Vec3.prototype.lengthSquared = Vec3.prototype.norm2, Vec3.prototype.distanceTo = function (p) {
            var x = this.x,
                y = this.y,
                z = this.z,
                px = p.x,
            ...
            return (target = target || new Vec3).x = vector.x * this.x, target.y = vector.y * this.y, target.z = vector.z * this.z, target
        }, Vec3.prototype.scale = Vec3.prototype.mult, Vec3.prototype.addScaledVector = function (scalar, vector, target) {
            return (target = target || new Vec3).x = this.x + scalar * vector.x, target.y = this.y + scalar * vector.y, target.z = this.z + scalar * vector.z, target
        }, Vec3.prototype.dot = function (v) {
            return this.x * v.x + this.y * v.y + this.z * v.z
        }, Vec3.prototype.isZero = function () {
            return 0 === this.x && 0 === this.y && 0 === this.z
        }, Vec3.prototype.negate = function (target) {
            return (target = target || new Vec3).x = -this.x, target.y = -this.y, target.z = -this.z, target
        };
        ...
        Vec3.prototype.tangents = function (t1, t2) {
            ...
            if (norm > 0) {
                ...
                Math.abs(n.x) < .9 ? (randVec.set(1, 0, 0), n.cross(randVec, t1)) : (randVec.set(0, 1, 0), n.cross(randVec, t1)), n.cross(t1, t2)
    ...
    35: [function (require, module, exports) {
        ...
        Body.prototype = new EventTarget, Body.prototype.constructor = Body, Body.COLLIDE_EVENT_NAME = "collide", Body.DYNAMIC = 1, Body.STATIC = 2, Body.KINEMATIC = 4, Body.AWAKE = 0, Body.SLEEPY = 1, Body.SLEEPING = 2, Body.idCounter = 0, Body.wakeupEvent = {
            ...
            if (this.allowSleep) {
                ...
                sleepState === Body.AWAKE && speedSquared < speedLimitSquared ? (this.sleepState = Body.SLEEPY, this.timeLastSleepy = time, this.dispatchEvent(Body.sleepyEvent)) : sleepState === Body.SLEEPY && speedSquared > speedLimitSquared ? this.wakeUp() : sleepState === Body.SLEEPY && time - this.timeLastSleepy > this.sleepTimeLimit && (this.sleep(), this.dispatchEvent(Body.sleepEvent))
            }
            ...
            result = result || new Vec3;
            return worldPoint.vsub(this.position, result), this.quaternion.conjugate().vmult(result, result), result
        }, Body.prototype.vectorToLocalFrame = function (worldVector, result) {
            result = result || new Vec3;
            return this.quaternion.conjugate().vmult(worldVector, result), result
        }, Body.prototype.pointToWorldFrame = function (localPoint, result) {
            result = result || new Vec3;
            return this.quaternion.vmult(localPoint, result), result.vadd(this.position, result), result
        ...
        Body.prototype.addShape = function (shape, _offset, _orientation) {
            ...
            return _offset && offset.copy(_offset), _orientation && orientation.copy(_orientation), this.shapes.push(shape), this.shapeOffsets.push(offset), this.shapeOrientations.push(orientation), this.updateMassProperties(), this.updateBoundingRadius(), this.aabbNeedsUpdate = !0, shape.body = this, this
        ...
        Body.prototype.computeAABB = function () {
            for (var shapes = this.shapes, shapeOffsets = this.shapeOffsets, shapeOrientations = this.shapeOrientations, N = shapes.length, offset = tmpVec, orientation = tmpQuat, bodyQuat = this.quaternion, aabb = this.aabb, shapeAABB = computeAABB_shapeAABB, i = 0; i !== N; i++) {
                var shape = shapes[i];
                bodyQuat.vmult(shapeOffsets[i], offset), offset.vadd(this.position, offset), shapeOrientations[i].mult(bodyQuat, orientation), shape.calculateWorldAABB(offset, orientation, shapeAABB.lowerBound, shapeAABB.upperBound), 0 === i ? aabb.copy(shapeAABB) : aabb.extend(shapeAABB)
            }
        ...
        Body.prototype.updateInertiaWorld = function (force) {
            ...
            if (I.x !== I.y || I.y !== I.z || force) {
                var m1 = uiw_m1,
                    m2 = uiw_m2;
                m1.setRotationFromQuaternion(this.quaternion), m1.transpose(m2), m1.scale(I, m1), m1.mmult(m2, this.invInertiaWorld)
            } else;
        };
        new Vec3;
        ...
        Body.prototype.applyForce = function (force, relativePoint) {
            if (this.type === Body.DYNAMIC) {
                ...
                relativePoint.cross(force, rotForce), this.force.vadd(force, this.force), this.torque.vadd(rotForce, this.torque)
            }
        };
        ...
        Body.prototype.applyLocalForce = function (localForce, localPoint) {
            if (this.type === Body.DYNAMIC) {
                ...
                this.vectorToWorldFrame(localForce, worldForce), this.vectorToWorldFrame(localPoint, relativePointWorld), this.applyForce(worldForce, relativePointWorld)
            }
        };
        new Vec3;
        ...
        Body.prototype.applyLocalImpulse = function (localImpulse, localPoint) {
            if (this.type === Body.DYNAMIC) {
                ...
                this.vectorToWorldFrame(localImpulse, worldImpulse), this.vectorToWorldFrame(localPoint, relativePointWorld), this.applyImpulse(worldImpulse, relativePointWorld)
            }
        };
        ...
        Body.prototype.updateMassProperties = function () {
            ...
            this.computeAABB(), halfExtents.set((this.aabb.upperBound.x - this.aabb.lowerBound.x) / 2, (this.aabb.upperBound.y - this.aabb.lowerBound.y) / 2, (this.aabb.upperBound.z - this.aabb.lowerBound.z) / 2), Box.calculateInertia(halfExtents, this.mass, I), this.invInertia.set(I.x > 0 && !fixed ? 1 / I.x : 0, I.y > 0 && !fixed ? 1 / I.y : 0, I.z > 0 && !fixed ? 1 / I.z : 0), this.updateInertiaWorld(!0)
        }, Body.prototype.getVelocityAtWorldPoint = function (worldPoint, result) {
            var r = new Vec3;
            return worldPoint.vsub(this.position, r), this.angularVelocity.cross(r, result), this.velocity.vadd(result, result), result
        };
        new Vec3, new Vec3, new Quaternion, new Quaternion;
        Body.prototype.integrate = function (dt, quatNormalize, quatNormalizeFast) {
            if (this.previousPosition.copy(this.position), this.previousQuaternion.copy(this.quaternion), (this.type === Body.DYNAMIC || this.type === Body.KINEMATIC) && this.sleepState !== Body.SLEEPING) {
                var velo = this.velocity,
                    ...
                    iMdt = invMass * dt;
                velo.x += force.x * iMdt * linearFactor.x, velo.y += force.y * iMdt * linearFactor.y, velo.z += force.z * iMdt * linearFactor.z;
                ...
                angularVelo.x += dt * (e[0] * tx + e[1] * ty + e[2] * tz), angularVelo.y += dt * (e[3] * tx + e[4] * ty + e[5] * tz), angularVelo.z += dt * (e[6] * tx + e[7] * ty + e[8] * tz), pos.x += velo.x * dt, pos.y += velo.y * dt, pos.z += velo.z * dt, quat.integrate(this.angularVelocity, dt, this.angularFactor, quat), quatNormalize && (quatNormalizeFast ? quat.normalizeFast() : quat.normalize()), this.aabbNeedsUpdate = !0, this.updateInertiaWorld()
            }
        }
    }, {
        "../collision/AABB": 6,
    ...
    36: [function (require, module, exports) {
        ...
        RaycastVehicle.prototype.applyEngineForce = function (value, wheelIndex) {
            ...
            result.set(0 === axisIndex ? 1 : 0, 1 === axisIndex ? 1 : 0, 2 === axisIndex ? 1 : 0), this.chassisBody.vectorToWorldFrame(result, result)
            ...
            for (i = 0; i < numWheels; i++) this.castRay(wheelInfos[i]);
            this.updateSuspension(timeStep);
            var impulse = new Vec3,
                relpos = new Vec3;
            for (i = 0; i < numWheels; i++) {
                var suspensionForce = (wheel = wheelInfos[i]).suspensionForce;
                suspensionForce > wheel.maxSuspensionForce && (suspensionForce = wheel.maxSuspensionForce), wheel.raycastResult.hitNormalWorld.scale(suspensionForce * timeStep, impulse), wheel.raycastResult.hitPointWorld.vsub(chassisBody.position, relpos), chassisBody.applyImpulse(impulse, relpos)
            }
            ...
            for (var chassisMass = this.chassisBody.mass, wheelInfos = this.wheelInfos, numWheels = wheelInfos.length, w_it = 0; w_it < numWheels; w_it++) {
                ...
                if (wheel.isInContact) {
                    ...
                    force -= (projected_rel_vel < 0 ? wheel.dampingCompression : wheel.dampingRelaxation) * projected_rel_vel, wheel.suspensionForce = force * chassisMass, wheel.suspensionForce < 0 && (wheel.suspensionForce = 0)
                } else wheel.suspensionForce = 0
            }
        }, RaycastVehicle.prototype.removeFromWorld = function (world) {
            this.constraints;
            world.remove(this.chassisBody), world.removeEventListener("preStep", this.preStepCallback), this.world = null
        };
        ...
        RaycastVehicle.prototype.castRay = function (wheel) {
            ...
            chassisBody.collisionResponse = !1, this.world.rayTest(source, target, raycastResult), chassisBody.collisionResponse = oldState;
            var object = raycastResult.body;
            if (wheel.raycastResult.groundObject = 0, object) {
                depth = raycastResult.distance, wheel.raycastResult.hitNormalWorld = raycastResult.hitNormalWorld, wheel.isInContact = !0;
                var hitDistance = raycastResult.distance;
                wheel.suspensionLength = hitDistance - wheel.radius;
                var minSuspensionLength = wheel.suspensionRestLength - wheel.maxSuspensionTravel,
                    maxSuspensionLength = wheel.suspensionRestLength + wheel.maxSuspensionTravel;
                wheel.suspensionLength < minSuspensionLength && (wheel.suspensionLength = minSuspensionLength), wheel.suspensionLength > maxSuspensionLength && (wheel.suspensionLength = maxSuspensionLength, wheel.raycastResult.reset());
            ...
            } else wheel.suspensionLength = wheel.suspensionRestLength + 0 * wheel.maxSuspensionTravel, wheel.suspensionRelativeVelocity = 0, wheel.directionWorld.scale(-1, wheel.raycastResult.hitNormalWorld), wheel.clippedInvContactDotSuspension = 1;
            return depth
        }, RaycastVehicle.prototype.updateWheelTransformWorld = function (wheel) {
            wheel.isInContact = !1;
            var chassisBody = this.chassisBody;
            chassisBody.pointToWorldFrame(wheel.chassisConnectionPointLocal, wheel.chassisConnectionPointWorld), chassisBody.vectorToWorldFrame(wheel.directionLocal, wheel.directionWorld), chassisBody.vectorToWorldFrame(wheel.axleLocal, wheel.axleWorld)
        }, RaycastVehicle.prototype.updateWheelTransform = function (wheelIndex) {
            var up = tmpVec4,
                right = tmpVec5,
                fwd = tmpVec6,
                wheel = this.wheelInfos[wheelIndex];
            this.updateWheelTransformWorld(wheel), wheel.directionLocal.scale(-1, up), right.copy(wheel.axleLocal), up.cross(right, fwd), fwd.normalize(), right.normalize();
        ...
        RaycastVehicle.prototype.updateFriction = function (timeStep) {
            for (var surfNormalWS_scaled_proj = updateFriction_surfNormalWS_scaled_proj, wheelInfos = this.wheelInfos, numWheels = wheelInfos.length, chassisBody = this.chassisBody, forwardWS = updateFriction_forwardWS, axle = updateFriction_axle, i = 0; i < numWheels; i++) {
                (groundObject = (wheel = wheelInfos[i]).raycastResult.body) && 0, wheel.sideImpulse = 0, wheel.forwardImpulse = 0, forwardWS[i] || (forwardWS[i] = new Vec3), axle[i] || (axle[i] = new Vec3)
            }
            for (i = 0; i < numWheels; i++) {
                if (groundObject = (wheel = wheelInfos[i]).raycastResult.body) {
                    ...
                    surfNormalWS.scale(proj, surfNormalWS_scaled_proj), axlei.vsub(surfNormalWS_scaled_proj, axlei), axlei.normalize(), surfNormalWS.cross(axlei, forwardWS[i]), forwardWS[i].normalize(), wheel.sideImpulse = resolveSingleBilateral(chassisBody, wheel.raycastResult.hitPointWorld, groundObject, wheel.raycastResult.hitPointWorld, axlei), wheel.sideImpulse *= 1
                }
            }
            this.sliding = !1;
            for (i = 0; i < numWheels; i++) {
                ...
                if (wheel.slipInfo = 1, groundObject) {
                    ...
                    var factor = maxImpulse / (rollingFriction += wheel.engineForce * timeStep);
            ...
            if (this.sliding)
                for (i = 0; i < numWheels; i++) {
                    0 !== (wheel = wheelInfos[i]).sideImpulse && wheel.skidInfo < 1 && (wheel.forwardImpulse *= wheel.skidInfo, wheel.sideImpulse *= wheel.skidInfo)
                }
            for (i = 0; i < numWheels; i++) {
                var wheel = wheelInfos[i],
                    rel_pos = new Vec3;
                if (wheel.raycastResult.hitPointWorld.vsub(chassisBody.position, rel_pos), 0 !== wheel.forwardImpulse) {
                    var impulse = new Vec3;
                ...
                if (0 !== wheel.sideImpulse) {
                    ...
                    axle[i].scale(wheel.sideImpulse, sideImp), chassisBody.vectorToLocalFrame(rel_pos, rel_pos), rel_pos["xyz" [this.indexUpAxis]] *= wheel.rollInfluence, chassisBody.vectorToWorldFrame(rel_pos, rel_pos), chassisBody.applyImpulse(sideImp, rel_pos), sideImp.scale(-1, sideImp), groundObject.applyImpulse(sideImp, rel_pos2)
                }
            }
        };
        ...
        function calcRollingFriction(body0, body1, frictionPosWorld, frictionDirectionWorld, maxImpulse) {
            ...
            body0.getVelocityAtWorldPoint(contactPosWorld, vel1), body1.getVelocityAtWorldPoint(contactPosWorld, vel2), vel1.vsub(vel2, vel);
            return maxImpulse < (j1 = -frictionDirectionWorld.dot(vel) * (1 / (computeImpulseDenominator(body0, frictionPosWorld, frictionDirectionWorld) + computeImpulseDenominator(body1, frictionPosWorld, frictionDirectionWorld)))) && (j1 = maxImpulse), j1 < -maxImpulse && (j1 = -maxImpulse), j1
        }
        ...
        function computeImpulseDenominator(body, pos, normal) {
            ...
            return pos.vsub(body.position, r0), r0.cross(normal, c0), body.invInertiaWorld.vmult(c0, m), m.cross(r0, vec), body.invMass + normal.dot(vec)
        }
        ...
        function resolveSingleBilateral(body1, pos1, body2, pos2, normal, impulse) {
            if (normal.norm2() > 1.1) return 0;
            var vel1 = resolveSingleBilateral_vel1,
                vel2 = resolveSingleBilateral_vel2,
                vel = resolveSingleBilateral_vel;
            body1.getVelocityAtWorldPoint(pos1, vel1), body2.getVelocityAtWorldPoint(pos2, vel2), vel1.vsub(vel2, vel);
    ...
    37: [function (require, module, exports) {
        ...
        function RigidVehicle(options) {
            if (this.wheelBodies = [], this.coordinateSystem = void 0 === options.coordinateSystem ? new Vec3(1, 2, 3) : options.coordinateSystem.clone(), this.chassisBody = options.chassisBody, !this.chassisBody) {
                var chassisShape = new Box(new Vec3(5, 2, .5));
                this.chassisBody = new Body(1, chassisShape)
            }
            this.constraints = [], this.wheelAxes = [], this.wheelForces = []
        }
        module.exports = RigidVehicle, RigidVehicle.prototype.addWheel = function (options) {
            var wheelBody = (options = options || {}).body;
            wheelBody || (wheelBody = new Body(1, new Sphere(1.2))), this.wheelBodies.push(wheelBody), this.wheelForces.push(0);
            new Vec3;
        ...
        RigidVehicle.prototype.setWheelForce = function (value, wheelIndex) {
            ...
            for (i = 0; i < constraints.length; i++) world.addConstraint(constraints[i]);
            ...
            for (i = 0; i < constraints.length; i++) world.removeConstraint(constraints[i])
        };
    ...
    38: [function (require, module, exports) {
        ...
        require("../shapes/Shape");
        var Vec3 = require("../math/Vec3");
        require("../math/Quaternion"), require("../shapes/Particle"), require("../objects/Body"), require("../material/Material");
        ...
        SPHSystem.prototype.add = function (particle) {
            ...
            var idx = this.particles.indexOf(particle); - 1 !== idx && (this.particles.splice(idx, 1), this.neighbors.length > this.particles.length && this.neighbors.pop())
        };
        ...
        SPHSystem.prototype.update = function () {
            for (var N = this.particles.length, dist = SPHSystem_update_dist, cs = this.speedOfSound, eps = this.eps, i = 0; i !== N; i++) {
                var p = this.particles[i];
                (neighbors = this.neighbors[i]).length = 0, this.getNeighbors(p, neighbors), neighbors.push(this.particles[i]);
    ...
    39: [function (require, module, exports) {
        ...
        function Spring(bodyA, bodyB, options) {
            options = options || {}, this.restLength = "number" == typeof options.restLength ? options.restLength : 1, this.stiffness = options.stiffness || 100, this.damping = options.damping || 1, this.bodyA = bodyA, this.bodyB = bodyB, this.localAnchorA = new Vec3, this.localAnchorB = new Vec3, options.localAnchorA && this.localAnchorA.copy(options.localAnchorA), options.localAnchorB && this.localAnchorB.copy(options.localAnchorB), options.worldAnchorA && this.setWorldAnchorA(options.worldAnchorA), options.worldAnchorB && this.setWorldAnchorB(options.worldAnchorB)
        }
        module.exports = Spring, Spring.prototype.setWorldAnchorA = function (worldAnchorA) {
        ...
        Spring.prototype.applyForce = function () {
            ...
            this.getWorldAnchorA(worldAnchorA), this.getWorldAnchorB(worldAnchorB), worldAnchorA.vsub(bodyA.position, ri), worldAnchorB.vsub(bodyB.position, rj), worldAnchorB.vsub(worldAnchorA, r);
            var rlen = r.norm();
            r_unit.copy(r), r_unit.normalize(), bodyB.velocity.vsub(bodyA.velocity, u), bodyB.angularVelocity.cross(rj, tmp), u.vadd(tmp, u), bodyA.angularVelocity.cross(ri, tmp), u.vsub(tmp, u), r_unit.mult(-k * (rlen - l) - d * u.dot(r_unit), f), bodyA.force.vsub(f, bodyA.force), bodyB.force.vadd(f, bodyB.force), ri.cross(f, ri_x_f), rj.cross(f, rj_x_f), bodyA.torque.vsub(ri_x_f, bodyA.torque), bodyB.torque.vadd(rj_x_f, bodyB.torque)
        }
    }, {
        "../math/Vec3": 34
    }],
    40: [function (require, module, exports) {
        ...
        WheelInfo.prototype.updateWheel = function (chassis) {
            ...
            if (this.isInContact) {
                ...
                if (project >= -.1) this.suspensionRelativeVelocity = 0, this.clippedInvContactDotSuspension = 10;
                else {
                    var inv = -1 / project;
                    this.suspensionRelativeVelocity = projVel * inv, this.clippedInvContactDotSuspension = inv
                }
            } else raycastResult.suspensionLength = this.suspensionRestLength, this.suspensionRelativeVelocity = 0, raycastResult.directionWorld.scale(-1, raycastResult.hitNormalWorld), this.clippedInvContactDotSuspension = 1
        }
    }, {
        "../collision/RaycastResult": 14,
        "../math/Transform": 33,
    ...
    41: [function (require, module, exports) {
        ...
        function Box(halfExtents) {
            Shape.call(this), this.type = Shape.types.BOX, this.halfExtents = halfExtents, this.convexPolyhedronRepresentation = null, this.updateConvexPolyhedronRepresentation(), this.updateBoundingSphereRadius()
        }
        Box.prototype = new Shape, Box.prototype.constructor = Box, Box.prototype.updateConvexPolyhedronRepresentation = function () {
            var sx = this.halfExtents.x,
                ...
                h = (new V(0, 0, 1), new V(0, 1, 0), new V(1, 0, 0), new ConvexPolyhedron(vertices, [
                    [3, 2, 1, 0],
                    [4, 5, 6, 7],
                    [5, 4, 0, 1],
                    [2, 3, 7, 6],
            ...
            return target = target || new Vec3, Box.calculateInertia(this.halfExtents, mass, target), target
        }, Box.calculateInertia = function (halfExtents, mass, target) {
            var e = halfExtents;
            target.x = 1 / 12 * mass * (2 * e.y * 2 * e.y + 2 * e.z * 2 * e.z), target.y = 1 / 12 * mass * (2 * e.x * 2 * e.x + 2 * e.z * 2 * e.z), target.z = 1 / 12 * mass * (2 * e.y * 2 * e.y + 2 * e.x * 2 * e.x)
        }, Box.prototype.getSideNormals = function (sixTargetVectors, quat) {
            var sides = sixTargetVectors,
                ex = this.halfExtents;
            if (sides[0].set(ex.x, 0, 0), sides[1].set(0, ex.y, 0), sides[2].set(0, 0, ex.z), sides[3].set(-ex.x, 0, 0), sides[4].set(0, -ex.y, 0), sides[5].set(0, 0, -ex.z), void 0 !== quat)
        ...
        Box.prototype.forEachWorldCorner = function (pos, quat, callback) {
            for (var e = this.halfExtents, corners = [
                    [e.x, e.y, e.z],
                    [-e.x, e.y, e.z],
                    [-e.x, -e.y, e.z],
                    [-e.x, -e.y, -e.z],
                    ...
                    [-e.x, e.y, -e.z],
                    [e.x, -e.y, e.z]
                ], i = 0; i < corners.length; i++) worldCornerTempPos.set(corners[i][0], corners[i][1], corners[i][2]), quat.vmult(worldCornerTempPos, worldCornerTempPos), pos.vadd(worldCornerTempPos, worldCornerTempPos), callback(worldCornerTempPos.x, worldCornerTempPos.y, worldCornerTempPos.z)
        };
        var worldCornersTemp = [new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3];
        Box.prototype.calculateWorldAABB = function (pos, quat, min, max) {
            var e = this.halfExtents;
            worldCornersTemp[0].set(e.x, e.y, e.z), worldCornersTemp[1].set(-e.x, e.y, e.z), worldCornersTemp[2].set(-e.x, -e.y, e.z), worldCornersTemp[3].set(-e.x, -e.y, -e.z), worldCornersTemp[4].set(e.x, -e.y, -e.z), worldCornersTemp[5].set(e.x, e.y, -e.z), worldCornersTemp[6].set(-e.x, e.y, -e.z), worldCornersTemp[7].set(e.x, -e.y, e.z);
            ...
            for (var i = 1; i < 8; i++) {
                ...
                var x = wc.x,
                    y = wc.y,
                    z = wc.z;
                x > max.x && (max.x = x), y > max.y && (max.y = y), z > max.z && (max.z = z), x < min.x && (min.x = x), y < min.y && (min.y = y), z < min.z && (min.z = z)
            }
        }
    }, {
        "../math/Vec3": 34,
    ...
    42: [function (require, module, exports) {
        ...
        var Shape = require("./Shape"),
            Vec3 = require("../math/Vec3"),
            Transform = (require("../math/Quaternion"), require("../math/Transform"));

        function ConvexPolyhedron(points, faces, uniqueAxes) {
            Shape.call(this), this.type = Shape.types.CONVEXPOLYHEDRON, this.vertices = points || [], this.worldVertices = [], this.worldVerticesNeedsUpdate = !0, this.faces = faces || [], this.faceNormals = [], this.computeNormals(), this.worldFaceNormalsNeedsUpdate = !0, this.worldFaceNormals = [], this.uniqueEdges = [], this.uniqueAxes = uniqueAxes ? uniqueAxes.slice() : null, this.computeEdges(), this.updateBoundingSphereRadius()
        }
        ConvexPolyhedron.prototype = new Shape, ConvexPolyhedron.prototype.constructor = ConvexPolyhedron;
        ...
        ConvexPolyhedron.prototype.computeEdges = function () {
            ...
            for (var i = 0; i < this.faces.length; i++) {
                for (var j = 0; j < this.faces[i].length; j++)
                    if (!this.vertices[this.faces[i][j]]) throw new Error("Vertex " + this.faces[i][j] + " not found!");
                var n = this.faceNormals[i] || new Vec3;
                this.getFaceNormal(i, n), n.negate(n), this.faceNormals[i] = n;
                var vertex = this.vertices[this.faces[i][0]];
                if (n.dot(vertex) < 0) {
                    console.error(".faceNormals[" + i + "] = Vec3(" + n.toString() + ") looks like it points into the shape? The vertices follow. Make sure they are ordered CCW around the normal, using the right hand rule.");
                    for (j = 0; j < this.faces[i].length; j++) console.warn(".vertices[" + this.faces[i][j] + "] = Vec3(" + this.vertices[this.faces[i][j]].toString() + ")")
                }
            }
        };
        var cb = new Vec3,
        ...
        ConvexPolyhedron.prototype.findSeparatingAxis = function (hullB, posA, quatA, posB, quatB, target, faceListA, faceListB) {
            ...
            if (this.uniqueAxes)
                for (i = 0; i !== this.uniqueAxes.length; i++) {
                    if (quatA.vmult(this.uniqueAxes[i], faceANormalWS3), !1 === (d = this.testSepAxis(faceANormalWS3, hullB, posA, quatA, posB, quatB))) return !1;
                    d < dmin && (dmin = d, target.copy(faceANormalWS3))
                } else
                    for (var numFacesA = faceListA ? faceListA.length : this.faces.length, i = 0; i < numFacesA; i++) {
                        var fi = faceListA ? faceListA[i] : i;
                        if (faceANormalWS3.copy(this.faceNormals[fi]), quatA.vmult(faceANormalWS3, faceANormalWS3), !1 === (d = this.testSepAxis(faceANormalWS3, hullB, posA, quatA, posB, quatB))) return !1;
                        d < dmin && (dmin = d, target.copy(faceANormalWS3))
                    }
            if (hullB.uniqueAxes)
                for (i = 0; i !== hullB.uniqueAxes.length; i++) {
                    if (quatB.vmult(hullB.uniqueAxes[i], Worldnormal1), 0, !1 === (d = this.testSepAxis(Worldnormal1, hullB, posA, quatA, posB, quatB))) return !1;
                    d < dmin && (dmin = d, target.copy(Worldnormal1))
                } else
                    for (var numFacesB = faceListB ? faceListB.length : hullB.faces.length, i = 0; i < numFacesB; i++) {
                        var d;
                        fi = faceListB ? faceListB[i] : i;
                        if (Worldnormal1.copy(hullB.faceNormals[fi]), quatB.vmult(Worldnormal1, Worldnormal1), 0, !1 === (d = this.testSepAxis(Worldnormal1, hullB, posA, quatA, posB, quatB))) return !1;
                        d < dmin && (dmin = d, target.copy(Worldnormal1))
                    }
            for (var e0 = 0; e0 !== this.uniqueEdges.length; e0++) {
                quatA.vmult(this.uniqueEdges[e0], worldEdge0);
                for (var e1 = 0; e1 !== hullB.uniqueEdges.length; e1++)
                    if (quatB.vmult(hullB.uniqueEdges[e1], worldEdge1), worldEdge0.cross(worldEdge1, Cross), !Cross.almostZero()) {
                        Cross.normalize();
            ...
            return posB.vsub(posA, deltaC), deltaC.dot(target) > 0 && target.negate(target), !0
        };
        var maxminA = [],
            maxminB = [];
        ...
        ConvexPolyhedron.prototype.calculateLocalInertia = function (mass, target) {
            ...
            target.x = 1 / 12 * mass * (2 * y * 2 * y + 2 * z * 2 * z), target.y = 1 / 12 * mass * (2 * x * 2 * x + 2 * z * 2 * z), target.z = 1 / 12 * mass * (2 * y * 2 * y + 2 * x * 2 * x)
        ...
        ConvexPolyhedron.prototype.clipFaceAgainstHull = function (separatingNormal, posA, quatA, worldVertsB1, minDist, maxDist, result) {
            ...
            if (!(closestFaceA < 0)) {
                ...
                for (var i = 0; i < this.faces.length; i++)
                    for (var j = 0; j < this.faces[i].length; j++) - 1 !== polyA.indexOf(this.faces[i][j]) && i !== closestFaceA && -1 === polyA.connectedFaces.indexOf(i) && polyA.connectedFaces.push(i);
                pVtxIn.length;
                for (var numVerticesA = polyA.length, e0 = 0; e0 < numVerticesA; e0++) {
                    var a = this.vertices[polyA[e0]],
                        b = this.vertices[polyA[(e0 + 1) % numVerticesA]];
                    a.vsub(b, edge0), WorldEdge0.copy(edge0), quatA.vmult(WorldEdge0, WorldEdge0), posA.vadd(WorldEdge0, WorldEdge0), worldPlaneAnormal1.copy(this.faceNormals[closestFaceA]), quatA.vmult(worldPlaneAnormal1, worldPlaneAnormal1), posA.vadd(worldPlaneAnormal1, worldPlaneAnormal1), WorldEdge0.cross(worldPlaneAnormal1, planeNormalWS1), planeNormalWS1.negate(planeNormalWS1), worldA1.copy(a), quatA.vmult(worldA1, worldA1), posA.vadd(worldA1, worldA1);
                ...
                localPlaneEq = this.getPlaneConstantOfFace(closestFaceA);
                planeNormalWS.copy(localPlaneNormal), quatA.vmult(planeNormalWS, planeNormalWS);
                for (planeEqWS = localPlaneEq - planeNormalWS.dot(posA), i = 0; i < pVtxIn.length; i++) {
                    var depth = planeNormalWS.dot(pVtxIn[i]) + planeEqWS;
                    if (depth <= minDist && (console.log("clamped: depth=" + depth + " to minDist=" + minDist), depth = minDist), depth <= maxDist) {
                        var point = pVtxIn[i];
                        if (depth <= 0) {
                            var p = {
                                point: point,
            ...
            for (var vi = 0; vi < numVerts; vi++) {
                if (lastVertex = inVertices[vi], n_dot_last = planeNormal.dot(lastVertex) + planeConstant, n_dot_first < 0)
                    if (n_dot_last < 0) {
                        (newv = new Vec3).copy(lastVertex), outVertices.push(newv)
                    } else {
                        var newv = new Vec3;
                    ...
                    newv = new Vec3;
                    firstVertex.lerp(lastVertex, n_dot_first / (n_dot_first - n_dot_last), newv), outVertices.push(newv), outVertices.push(lastVertex)
                }
            ...
            for (var verts = this.vertices, worldVerts = this.worldVertices, i = 0; i !== N; i++) quat.vmult(verts[i], worldVerts[i]), position.vadd(worldVerts[i], worldVerts[i]);
        ...
        ConvexPolyhedron.prototype.computeLocalAABB = function (aabbmin, aabbmax) {
            ...
            for (var i = 0; i < n; i++) {
                var v = vertices[i];
                v.x < aabbmin.x ? aabbmin.x = v.x : v.x > aabbmax.x && (aabbmax.x = v.x), v.y < aabbmin.y ? aabbmin.y = v.y : v.y > aabbmax.y && (aabbmax.y = v.y), v.z < aabbmin.z ? aabbmin.z = v.z : v.z > aabbmax.z && (aabbmax.z = v.z)
            }
        ...
        ConvexPolyhedron.prototype.calculateWorldAABB = function (pos, quat, min, max) {
            for (var minx, miny, minz, maxx, maxy, maxz, n = this.vertices.length, verts = this.vertices, i = 0; i < n; i++) {
                ...
                v.x < minx || void 0 === minx ? minx = v.x : (v.x > maxx || void 0 === maxx) && (maxx = v.x), v.y < miny || void 0 === miny ? miny = v.y : (v.y > maxy || void 0 === maxy) && (maxy = v.y), v.z < minz || void 0 === minz ? minz = v.z : (v.z > maxz || void 0 === maxz) && (maxz = v.z)
            }
        ...
        ConvexPolyhedron.prototype.pointIsInside = function (p) {
            ...
            for (var i = 0; i < N; i++) {
                this.faces[i].length, n = normals[i];
        ...
        ConvexPolyhedron.project = function (hull, axis, pos, quat, result) {
            var n = hull.vertices.length,
                ...
                vs = hull.vertices;
            localOrigin.setZero(), Transform.vectorToLocalFrame(pos, quat, axis, localAxis), Transform.pointToLocalFrame(pos, quat, localOrigin, localOrigin);
    ...
    43: [function (require, module, exports) {
        ...
        var Shape = require("./Shape"),
            Vec3 = require("../math/Vec3"),
            ConvexPolyhedron = (require("../math/Quaternion"), require("./ConvexPolyhedron"));
        ...
        function Cylinder(radiusTop, radiusBottom, height, numSegments) {
            var N = numSegments,
                ...
                cos = Math.cos,
                sin = Math.sin;
            verts.push(new Vec3(radiusBottom * cos(0), radiusBottom * sin(0), .5 * -height)), bottomface.push(0), verts.push(new Vec3(radiusTop * cos(0), radiusTop * sin(0), .5 * height)), topface.push(1);
            for (var i = 0; i < N; i++) {
                var theta = 2 * Math.PI / N * (i + 1),
                    thetaN = 2 * Math.PI / N * (i + .5);
                i < N - 1 ? (verts.push(new Vec3(radiusBottom * cos(theta), radiusBottom * sin(theta), .5 * -height)), bottomface.push(2 * i + 2), verts.push(new Vec3(radiusTop * cos(theta), radiusTop * sin(theta), .5 * height)), topface.push(2 * i + 3), faces.push([2 * i + 2, 2 * i + 3, 2 * i + 1, 2 * i])) : faces.push([0, 1, 2 * i + 1, 2 * i]), (N % 2 == 1 || i < N / 2) && axes.push(new Vec3(cos(thetaN), sin(thetaN), 0))
            }
            faces.push(topface), axes.push(new Vec3(0, 0, 1));
            var temp = [];
            for (i = 0; i < bottomface.length; i++) temp.push(bottomface[bottomface.length - i - 1]);
    ...
    44: [function (require, module, exports) {
        ...
        function Heightfield(data, options) {
            options = Utils.defaults(options, {
                ...
                minValue: null,
                elementSize: 1
            }), this.data = data, this.maxValue = options.maxValue, this.minValue = options.minValue, this.elementSize = options.elementSize, null === options.minValue && this.updateMinValue(), null === options.maxValue && this.updateMaxValue(), this.cacheEnabled = !0, Shape.call(this), this.pillarConvex = new ConvexPolyhedron, this.pillarOffset = new Vec3, this.type = Shape.types.HEIGHTFIELD, this.updateBoundingSphereRadius(), this._cachedPillars = {}
        }
        module.exports = Heightfield, Heightfield.prototype = new Shape, Heightfield.prototype.update = function () {
            this._cachedPillars = {}
            ...
            this.data[xi][yi] = value, this.clearCachedConvexTrianglePillar(xi, yi, !1), xi > 0 && (this.clearCachedConvexTrianglePillar(xi - 1, yi, !0), this.clearCachedConvexTrianglePillar(xi - 1, yi, !1)), yi > 0 && (this.clearCachedConvexTrianglePillar(xi, yi - 1, !0), this.clearCachedConvexTrianglePillar(xi, yi - 1, !1)), yi > 0 && xi > 0 && this.clearCachedConvexTrianglePillar(xi - 1, yi - 1, !0)
            ...
            var w = this.elementSize,
                ...
                xi = Math.floor(x / w),
                yi = Math.floor(y / w);
            return result[0] = xi, result[1] = yi, clamp && (xi < 0 && (xi = 0), yi < 0 && (yi = 0), xi >= data.length - 1 && (xi = data.length - 1), yi >= data[0].length - 1 && (yi = data[0].length - 1)), !(xi < 0 || yi < 0 || xi >= data.length - 1 || yi >= data[0].length - 1)
        };
        var getHeightAt_idx = [],
        ...
        Heightfield.prototype.getNormalAt = function (x, y, edgeClamp, result) {
            var a = getNormalAt_a,
                ...
                e0 = getNormalAt_e0,
                e1 = getNormalAt_e1;
            this.getTriangleAt(x, y, edgeClamp, a, b, c), b.vsub(a, e0), c.vsub(a, e1), e0.cross(e1, result), result.normalize()
        }, Heightfield.prototype.getAabbAtIndex = function (xi, yi, result) {
            var data = this.data,
                elementSize = this.elementSize;
            result.lowerBound.set(xi * elementSize, yi * elementSize, data[xi][yi]), result.upperBound.set((xi + 1) * elementSize, (yi + 1) * elementSize, data[xi + 1][yi + 1])
            ...
            ! function (x, y, ax, ay, bx, by, cx, cy, result) {
                result.x = ((by - cy) * (x - cx) + (cx - bx) * (y - cy)) / ((by - cy) * (ax - cx) + (cx - bx) * (ay - cy)), result.y = ((cy - ay) * (x - cx) + (ax - cx) * (y - cy)) / ((by - cy) * (ax - cx) + (cx - bx) * (ay - cy)), result.z = 1 - result.x - result.y
            ...
            var data = this.data,
                elementSize = this.elementSize;
            upper ? (a.set((xi + 1) * elementSize, (yi + 1) * elementSize, data[xi + 1][yi + 1]), b.set(xi * elementSize, (yi + 1) * elementSize, data[xi][yi + 1]), c.set((xi + 1) * elementSize, yi * elementSize, data[xi + 1][yi])) : (a.set(xi * elementSize, yi * elementSize, data[xi][yi]), b.set((xi + 1) * elementSize, yi * elementSize, data[xi + 1][yi]), c.set(xi * elementSize, (yi + 1) * elementSize, data[xi][yi + 1]))
        }, Heightfield.prototype.getConvexTrianglePillar = function (xi, yi, getUpperTriangle) {
            var result = this.pillarConvex,
                offsetResult = this.pillarOffset;
            if (this.cacheEnabled) {
                if (data = this.getCachedConvexTrianglePillar(xi, yi, getUpperTriangle)) return this.pillarConvex = data.convex, void(this.pillarOffset = data.offset);
                result = new ConvexPolyhedron, offsetResult = new Vec3, this.pillarConvex = result, this.pillarOffset = offsetResult
            }
            var data = this.data,
                elementSize = this.elementSize,
                faces = result.faces;
            ...
            var imageData = context.getImageData(0, 0, image.width, image.height),
                matrix = this.data;
            matrix.length = 0, this.elementSize = Math.abs(scale.x) / imageData.width;
    ...
    45: [function (require, module, exports) {
        ...
        Particle.prototype = new Shape, Particle.prototype.constructor = Particle, Particle.prototype.calculateLocalInertia = function (mass, target) {
            return (target = target || new Vec3).set(0, 0, 0), target
    ...
    46: [function (require, module, exports) {
        ...
        function Plane() {
            Shape.call(this), this.type = Shape.types.PLANE, this.worldNormal = new Vec3, this.worldNormalNeedsUpdate = !0, this.boundingSphereRadius = Number.MAX_VALUE
        }
        Plane.prototype = new Shape, Plane.prototype.constructor = Plane, Plane.prototype.computeWorldNormal = function (quat) {
        ...
        Plane.prototype.calculateWorldAABB = function (pos, quat, min, max) {
            ...
            min.set(-maxVal, -maxVal, -maxVal), max.set(maxVal, maxVal, maxVal), 1 === tempNormal.x && (max.x = pos.x), 1 === tempNormal.y && (max.y = pos.y), 1 === tempNormal.z && (max.z = pos.z), -1 === tempNormal.x && (min.x = pos.x), -1 === tempNormal.y && (min.y = pos.y), -1 === tempNormal.z && (min.z = pos.z)
    ...
    47: [function (require, module, exports) {
        ...
        var Shape = require("./Shape");
        require("../math/Vec3"), require("../math/Quaternion"), require("../material/Material");

        function Shape() {
            this.id = Shape.idCounter++, this.type = 0, this.boundingSphereRadius = 0, this.collisionResponse = !0, this.material = null, this.body = null
        }
        Shape.prototype.constructor = Shape, Shape.prototype.updateBoundingSphereRadius = function () {
    ...
    48: [function (require, module, exports) {
        ...
        function Sphere(radius) {
            if (Shape.call(this), this.radius = void 0 !== radius ? Number(radius) : 1, this.type = Shape.types.SPHERE, this.radius < 0) throw new Error("The sphere radius cannot be negative.");
            this.updateBoundingSphereRadius()
        }
        Sphere.prototype = new Shape, Sphere.prototype.constructor = Sphere, Sphere.prototype.calculateLocalInertia = function (mass, target) {
            target = target || new Vec3;
    ...
    49: [function (require, module, exports) {
        ...
        function Trimesh(vertices, indices) {
            Shape.call(this), this.type = Shape.types.TRIMESH, this.vertices = new Float32Array(vertices), this.indices = new Int16Array(indices), this.normals = new Float32Array(indices.length), this.aabb = new AABB, this.edges = null, this.scale = new Vec3(1, 1, 1), this.tree = new Octree, this.updateEdges(), this.updateNormals(), this.updateAABB(), this.updateBoundingSphereRadius(), this.updateTree()
        }
        Trimesh.prototype = new Shape, Trimesh.prototype.constructor = Trimesh;
        var computeNormals_n = new Vec3;
        Trimesh.prototype.updateTree = function () {
            var tree = this.tree;
            tree.reset(), tree.aabb.copy(this.aabb);
            var scale = this.scale;
            tree.aabb.lowerBound.x *= 1 / scale.x, tree.aabb.lowerBound.y *= 1 / scale.y, tree.aabb.lowerBound.z *= 1 / scale.z, tree.aabb.upperBound.x *= 1 / scale.x, tree.aabb.upperBound.y *= 1 / scale.y, tree.aabb.upperBound.z *= 1 / scale.z;
            for (var triangleAABB = new AABB, a = new Vec3, b = new Vec3, c = new Vec3, points = [a, b, c], i = 0; i < this.indices.length / 3; i++) {
                var i3 = 3 * i;
                this._getUnscaledVertex(this.indices[i3], a), this._getUnscaledVertex(this.indices[i3 + 1], b), this._getUnscaledVertex(this.indices[i3 + 2], c), triangleAABB.setFromPoints(points), tree.insert(triangleAABB, i)
            }
        ...
        Trimesh.prototype.getTrianglesInAABB = function (aabb, result) {
            ...
            wasUniform && isUniform || this.updateNormals(), this.scale.copy(scale), this.updateAABB(), this.updateBoundingSphereRadius()
            ...
            for (var n = computeNormals_n, normals = this.normals, i = 0; i < this.indices.length / 3; i++) {
                var i3 = 3 * i,
                    ...
                    b = this.indices[i3 + 1],
                    c = this.indices[i3 + 2];
                this.getVertex(a, va), this.getVertex(b, vb), this.getVertex(c, vc), Trimesh.computeNormal(vb, va, vc, n), normals[i3] = n.x, normals[i3 + 1] = n.y, normals[i3 + 2] = n.z
            }
        ...
        Trimesh.prototype.getVertex = function (i, out) {
            var scale = this.scale;
            return this._getUnscaledVertex(i, out), out.x *= scale.x, out.y *= scale.y, out.z *= scale.z, out
        }, Trimesh.prototype._getUnscaledVertex = function (i, out) {
            var i3 = 3 * i,
                vertices = this.vertices;
            return out.set(vertices[i3], vertices[i3 + 1], vertices[i3 + 2])
        }, Trimesh.prototype.getWorldVertex = function (i, pos, quat, out) {
            return this.getVertex(i, out), Transform.pointToWorldFrame(pos, quat, out, out), out
        ...
        Trimesh.prototype.computeLocalAABB = function (aabb) {
            ...
            for (var i = 0; i !== n; i++) this.getVertex(i, v), v.x < l.x ? l.x = v.x : v.x > u.x && (u.x = v.x), v.y < l.y ? l.y = v.y : v.y > u.y && (u.y = v.y), v.z < l.z ? l.z = v.z : v.z > u.z && (u.z = v.z)
        ...
        Trimesh.prototype.calculateWorldAABB = function (pos, quat, min, max) {
            ...
            frame.position = pos, frame.quaternion = quat, this.aabb.toWorldFrame(frame, result), min.copy(result.lowerBound), max.copy(result.upperBound)
        }, Trimesh.prototype.volume = function () {
            return 4 * Math.PI * this.boundingSphereRadius / 3
        }, Trimesh.createTorus = function (radius, tube, radialSegments, tubularSegments, arc) {
            radius = radius || 1, tube = tube || .5, radialSegments = radialSegments || 8, tubularSegments = tubularSegments || 6, arc = arc || 2 * Math.PI;
    ...
    50: [function (require, module, exports) {
        ...
        require("../math/Vec3"), require("../math/Quaternion");
        ...
        GSSolver.prototype.solve = function (dt, world) {
            var B, invC, deltalambda, deltalambdaTot, lambdaj, iter = 0,
            ...
            if (0 !== Neq) {
                ...
                for (iter = 0; iter !== maxIter; iter++) {
                    ...
                    for (var j = 0; j !== Neq; j++) {
                        c = equations[j];
                        B = Bs[j], invC = invCs[j], (lambdaj = lambda[j]) + (deltalambda = invC * (B - c.computeGWlambda() - c.eps * lambdaj)) < c.minForce ? deltalambda = c.minForce - lambdaj : lambdaj + deltalambda > c.maxForce && (deltalambda = c.maxForce - lambdaj), lambda[j] += deltalambda, deltalambdaTot += deltalambda > 0 ? deltalambda : -deltalambda, c.addToWlambda(deltalambda)
                    }
                    if (deltalambdaTot * deltalambdaTot < tolSquared) break
                }
                for (i = 0; i !== Nbodies; i++) {
                    var b, v = (b = bodies[i]).velocity,
                        w = b.angularVelocity;
                    b.vlambda.vmul(b.linearFactor, b.vlambda), v.vadd(b.vlambda, v), b.wlambda.vmul(b.angularFactor, b.wlambda), w.vadd(b.wlambda, w)
                }
    ...
    51: [function (require, module, exports) {
        ...
        module.exports = Solver, Solver.prototype.solve = function (dt, world) {
            return 0
        }, Solver.prototype.addEquation = function (eq) {
            eq.enabled && this.equations.push(eq)
        }, Solver.prototype.removeEquation = function (eq) {
            var eqs = this.equations,
                i = eqs.indexOf(eq); - 1 !== i && eqs.splice(i, 1)
    ...
    52: [function (require, module, exports) {
        ...
        function SplitSolver(subsolver) {
            for (Solver.call(this), this.iterations = 10, this.tolerance = 1e-7, this.subsolver = subsolver, this.nodes = [], this.nodePool = []; this.nodePool.length < 128;) this.nodePool.push(this.createNode())
        }
        ...
        function bfs(root, visitFunc, bds, eqs) {
            for (queue.push(root), root.visited = !0, visitFunc(root, bds, eqs); queue.length;)
                for (var child, node = queue.pop(); child = getUnvisitedNode(node.children);) child.visited = !0, visitFunc(child, bds, eqs), queue.push(child)
        }

        function visitFunc(node, bds, eqs) {
            bds.push(node.body);
            for (var Neqs = node.eqs.length, i = 0; i !== Neqs; i++) {
                var eq = node.eqs[i]; - 1 === eqs.indexOf(eq) && eqs.push(eq)
            }
        }
        ...
        SplitSolver.prototype.createNode = function () {
            ...
            for (var k = 0; k !== Neq; k++) {
                var eq = equations[k],
                    j = (i = bodies.indexOf(eq.bi), bodies.indexOf(eq.bj)),
                    ni = nodes[i],
                    nj = nodes[j];
            ...
            for (var dummyWorld = SplitSolver_solve_dummyWorld; child = getUnvisitedNode(nodes);) {
                ...
                for (i = 0; i !== Neqs; i++) subsolver.addEquation(eqs[i]);
    ...
    53: [function (require, module, exports) {
        ...
        module.exports = EventTarget, EventTarget.prototype = {
            constructor: EventTarget,
            addEventListener: function (type, listener) {
                void 0 === this._listeners && (this._listeners = {});
                var listeners = this._listeners;
                return void 0 === listeners[type] && (listeners[type] = []), -1 === listeners[type].indexOf(listener) && listeners[type].push(listener), this
            },
    ...
    54: [function (require, module, exports) {
        ...
        function OctreeNode(options) {
            options = options || {}, this.root = options.root || null, this.aabb = options.aabb ? options.aabb.clone() : new AABB, this.data = [], this.children = []
        }

        function Octree(aabb, options) {
            (options = options || {}).root = null, options.aabb = aabb, OctreeNode.call(this, options), this.maxDepth = void 0 !== options.maxDepth ? options.maxDepth : 8
        }
        module.exports = Octree, Octree.prototype = new OctreeNode, OctreeNode.prototype.reset = function (aabb, options) {
        ...
        OctreeNode.prototype.subdivide = function () {
            ...
            for (var root = this.root || this, i = 0; 8 !== i; i++) {
                ...
                lowerBound.x *= halfDiagonal.x, lowerBound.y *= halfDiagonal.y, lowerBound.z *= halfDiagonal.z, lowerBound.vadd(l, lowerBound), lowerBound.vadd(halfDiagonal, child.aabb.upperBound)
            }
        ...
        OctreeNode.prototype.rayQuery = function (ray, treeTransform, result) {
            return ray.getAABB(tmpAABB), tmpAABB.toLocalFrame(treeTransform, tmpAABB), this.aabbQuery(tmpAABB, result), result
        }, OctreeNode.prototype.removeEmptyNodes = function () {
            for (var queue = [this]; queue.length;) {
                for (var node = queue.pop(), i = node.children.length - 1; i >= 0; i--) node.children[i].data.length || node.children.splice(i, 1);
    ...
    55: [function (require, module, exports) {
        ...
        module.exports = Pool, Pool.prototype.release = function () {
    ...
    56: [function (require, module, exports) {
        ...
        module.exports = TupleDictionary, TupleDictionary.prototype.get = function (i, j) {
            if (i > j) {
                var temp = j;
                j = i, i = temp
            }
    ...
    57: [function (require, module, exports) {
        function Utils() {}
        module.exports = Utils, Utils.defaults = function (options, defaults) {
    ...
    58: [function (require, module, exports) {
        ...
        Vec3Pool.prototype = new Pool, Vec3Pool.prototype.constructObject = function () {
            return new Vec3
        }
    }, {
        "../math/Vec3": 34,
    ...
    59: [function (require, module, exports) {
        ...
        var AABB = require("../collision/AABB"),
            ...
            Vec3 = require("../math/Vec3"),
            Transform = require("../math/Transform"),
            Quaternion = (require("../shapes/ConvexPolyhedron"), require("../math/Quaternion")),
            Vec3Pool = (require("../solver/Solver"), require("../utils/Vec3Pool")),
            ContactEquation = require("../equations/ContactEquation"),
            FrictionEquation = require("../equations/FrictionEquation");

        function Narrowphase(world) {
            this.contactPointPool = [], this.frictionEquationPool = [], this.result = [], this.frictionResult = [], this.v3pool = new Vec3Pool, this.world = world, this.currentContactMaterial = null, this.enableFrictionReduction = !1
        }
        Narrowphase.prototype.createContactEquation = function (bi, bj, si, sj, overrideShapeA, overrideShapeB) {
            var c;
            this.contactPointPool.length ? ((c = this.contactPointPool.pop()).bi = bi, c.bj = bj) : c = new ContactEquation(bi, bj), c.enabled = bi.collisionResponse && bj.collisionResponse && si.collisionResponse && sj.collisionResponse;
            ...
            return matA && matB && matA.restitution >= 0 && matB.restitution >= 0 && (c.restitution = matA.restitution * matB.restitution), c.si = overrideShapeA || si, c.sj = overrideShapeB || sj, c
            ...
            if (matA && matB && matA.friction >= 0 && matB.friction >= 0 && (friction = matA.friction * matB.friction), friction > 0) {
                ...
                return c1.bi = c2.bi = bodyA, c1.bj = c2.bj = bodyB, c1.minForce = c2.minForce = -mug * reducedMass, c1.maxForce = c2.maxForce = mug * reducedMass, c1.ri.copy(contactEquation.ri), c1.rj.copy(contactEquation.rj), c2.ri.copy(contactEquation.ri), c2.rj.copy(contactEquation.rj), contactEquation.ni.tangents(c1.t, c2.t), c1.setSpookParams(cm.frictionEquationStiffness, cm.frictionEquationRelaxation, world.dt), c2.setSpookParams(cm.frictionEquationStiffness, cm.frictionEquationRelaxation, world.dt), c1.enabled = c2.enabled = contactEquation.enabled, outArray.push(c1, c2), !0
            }
            return !1
        };
        ...
        Narrowphase.prototype.createFrictionFromAverage = function (numContacts) {
            ...
            if (this.createFrictionEquationsFromContact(c, this.frictionResult) && 1 !== numContacts) {
                ...
                for (var bodyA = c.bi, i = (c.bj, 0); i !== numContacts; i++)(c = this.result[this.result.length - 1 - i]).bodyA !== bodyA ? (averageNormal.vadd(c.ni, averageNormal), averageContactPointA.vadd(c.ri, averageContactPointA), averageContactPointB.vadd(c.rj, averageContactPointB)) : (averageNormal.vsub(c.ni, averageNormal), averageContactPointA.vadd(c.rj, averageContactPointA), averageContactPointB.vadd(c.ri, averageContactPointB));
                var invNumContacts = 1 / numContacts;
                averageContactPointA.scale(invNumContacts, f1.ri), averageContactPointB.scale(invNumContacts, f1.rj), f2.ri.copy(f1.ri), f2.rj.copy(f1.rj), averageNormal.normalize(), averageNormal.tangents(f1.t, f2.t)
            }
        };
        var tmpVec1 = new Vec3,
            tmpVec2 = new Vec3,
        ...
        Narrowphase.prototype.getContacts = function (p1, p2, world, result, oldcontacts, frictionResult, frictionPool) {
            this.contactPointPool = oldcontacts, this.frictionEquationPool = frictionPool, this.result = result, this.frictionResult = frictionResult;
            for (var qi = tmpQuat1, qj = tmpQuat2, xi = tmpVec1, xj = tmpVec2, k = 0, N = p1.length; k !== N; k++) {
                ...
                for (var justTest = bi.type & Body.KINEMATIC && bj.type & Body.STATIC || bi.type & Body.STATIC && bj.type & Body.KINEMATIC || bi.type & Body.KINEMATIC && bj.type & Body.KINEMATIC, i = 0; i < bi.shapes.length; i++) {
                    bi.quaternion.mult(bi.shapeOrientations[i], qi), bi.quaternion.vmult(bi.shapeOffsets[i], xi), xi.vadd(bi.position, xi);
                    for (var si = bi.shapes[i], j = 0; j < bj.shapes.length; j++) {
                        bj.quaternion.mult(bj.shapeOrientations[j], qj), bj.quaternion.vmult(bj.shapeOffsets[j], xj), xj.vadd(bj.position, xj);
                        var sj = bj.shapes[j];
                        if (!(xi.distanceTo(xj) > si.boundingSphereRadius + sj.boundingSphereRadius)) {
                            var shapeContactMaterial = null;
                            si.material && sj.material && (shapeContactMaterial = world.getContactMaterial(si.material, sj.material) || null), this.currentContactMaterial = shapeContactMaterial || bodyContactMaterial || world.defaultContactMaterial;
                            var resolver = this[si.type | sj.type];
                            if (resolver) {
                                (si.type < sj.type ? resolver.call(this, si, sj, xi, xj, qi, qj, bi, bj, si, sj, justTest) : resolver.call(this, sj, si, xj, xi, qj, qi, bj, bi, si, sj, justTest)) && justTest && (world.shapeOverlapKeeper.set(si.id, sj.id), world.bodyOverlapKeeper.set(bi.id, bj.id))
                            }
                        }
                    }
                }
        ...
        Narrowphase.prototype[Shape.types.BOX | Shape.types.BOX] = Narrowphase.prototype.boxBox = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
            ...
            return si.convexPolyhedronRepresentation.material = si.material, si.convexPolyhedronRepresentation.collisionResponse = si.collisionResponse, this.convexConvex(si.convexPolyhedronRepresentation, sj, xi, xj, qi, qj, bi, bj, si, sj, justTest)
            ...
            return si.convexPolyhedronRepresentation.material = si.material, si.convexPolyhedronRepresentation.collisionResponse = si.collisionResponse, this.convexParticle(si.convexPolyhedronRepresentation, sj, xi, xj, qi, qj, bi, bj, si, sj, justTest)
            ...
            xj.vsub(xi, r.ni), r.ni.normalize(), r.ri.copy(r.ni), r.rj.copy(r.ni), r.ri.mult(si.radius, r.ri), r.rj.mult(-sj.radius, r.rj), r.ri.vadd(xi, r.ri), r.ri.vsub(bi.position, r.ri), r.rj.vadd(xj, r.rj), r.rj.vsub(bj.position, r.rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
        };
        ...
        Narrowphase.prototype[Shape.types.PLANE | Shape.types.TRIMESH] = Narrowphase.prototype.planeTrimesh = function (planeShape, trimeshShape, planePos, trimeshPos, planeQuat, trimeshQuat, planeBody, trimeshBody, rsi, rsj, justTest) {
            ...
            for (var i = 0; i < trimeshShape.vertices.length / 3; i++) {
                ...
                if (v.vsub(planePos, relpos), normal.dot(relpos) <= 0) {
                    ...
                    normal.scale(relpos.dot(normal), projected), v.vsub(projected, projected), r.ri.copy(projected), r.ri.vsub(planeBody.position, r.ri), r.rj.copy(v), r.rj.vsub(trimeshBody.position, r.rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                }
            }
        };
        var sphereTrimesh_normal = new Vec3,
            sphereTrimesh_relpos = new Vec3,
            sphereTrimesh_v = (new Vec3, new Vec3),
        ...
        Narrowphase.prototype[Shape.types.SPHERE | Shape.types.TRIMESH] = Narrowphase.prototype.sphereTrimesh = function (sphereShape, trimeshShape, spherePos, trimeshPos, sphereQuat, trimeshQuat, sphereBody, trimeshBody, rsi, rsj, justTest) {
            ...
            localSphereAABB.lowerBound.set(localSpherePos.x - sphereRadius, localSpherePos.y - sphereRadius, localSpherePos.z - sphereRadius), localSphereAABB.upperBound.set(localSpherePos.x + sphereRadius, localSpherePos.y + sphereRadius, localSpherePos.z + sphereRadius), trimeshShape.getTrianglesInAABB(localSphereAABB, triangles);
            for (var v = sphereTrimesh_v, radiusSquared = sphereShape.radius * sphereShape.radius, i = 0; i < triangles.length; i++)
                for (var j = 0; j < 3; j++)
                    if (trimeshShape.getVertex(trimeshShape.indices[3 * triangles[i] + j], v), v.vsub(localSpherePos, relpos), relpos.norm2() <= radiusSquared) {
                        if (v2.copy(v), Transform.pointToWorldFrame(trimeshPos, trimeshQuat, v2, v), v.vsub(spherePos, relpos), justTest) return !0;
                ...
                for (j = 0; j < 3; j++) {
                    trimeshShape.getVertex(trimeshShape.indices[3 * triangles[i] + j], edgeVertexA), trimeshShape.getVertex(trimeshShape.indices[3 * triangles[i] + (j + 1) % 3], edgeVertexB), edgeVertexB.vsub(edgeVertexA, edgeVector), localSpherePos.vsub(edgeVertexB, tmp);
                    var positionAlongEdgeB = tmp.dot(edgeVector);
                    localSpherePos.vsub(edgeVertexA, tmp);
                    var positionAlongEdgeA = tmp.dot(edgeVector);
                    if (positionAlongEdgeA > 0 && positionAlongEdgeB < 0)
                        if (localSpherePos.vsub(edgeVertexA, tmp), edgeVectorUnit.copy(edgeVector), edgeVectorUnit.normalize(), positionAlongEdgeA = tmp.dot(edgeVectorUnit), edgeVectorUnit.scale(positionAlongEdgeA, tmp), tmp.vadd(edgeVertexA, tmp), (dist = tmp.distanceTo(localSpherePos)) < sphereShape.radius) {
                            if (justTest) return !0;
                            var r = this.createContactEquation(sphereBody, trimeshBody, sphereShape, trimeshShape, rsi, rsj);
                            tmp.vsub(localSpherePos, r.ni), r.ni.normalize(), r.ni.scale(sphereShape.radius, r.ri), Transform.pointToWorldFrame(trimeshPos, trimeshQuat, tmp, tmp), tmp.vsub(trimeshBody.position, r.rj), Transform.vectorToWorldFrame(trimeshQuat, r.ni, r.ni), Transform.vectorToWorldFrame(trimeshQuat, r.ri, r.ri), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                        }
                }
            for (var va = sphereTrimesh_va, vb = sphereTrimesh_vb, vc = sphereTrimesh_vc, normal = sphereTrimesh_normal, N = (i = 0, triangles.length); i !== N; i++) {
                trimeshShape.getTriangleVertices(triangles[i], va, vb, vc), trimeshShape.getNormal(triangles[i], normal), localSpherePos.vsub(va, tmp);
                var dist = tmp.dot(normal);
                if (normal.scale(dist, tmp), localSpherePos.vsub(tmp, tmp), dist = tmp.distanceTo(localSpherePos), Ray.pointInTriangle(tmp, va, vb, vc) && dist < sphereShape.radius) {
                    if (justTest) return !0;
        ...
        Narrowphase.prototype[Shape.types.SPHERE | Shape.types.PLANE] = Narrowphase.prototype.spherePlane = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
            var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
            if (r.ni.set(0, 0, 1), qj.vmult(r.ni, r.ni), r.ni.negate(r.ni), r.ni.normalize(), r.ni.mult(si.radius, r.ri), xi.vsub(xj, point_on_plane_to_sphere), r.ni.mult(r.ni.dot(point_on_plane_to_sphere), plane_to_sphere_ortho), point_on_plane_to_sphere.vsub(plane_to_sphere_ortho, r.rj), -point_on_plane_to_sphere.dot(r.ni) <= si.radius) {
                if (justTest) return !0;
                var ri = r.ri,
                    rj = r.rj;
                ri.vadd(xi, ri), ri.vsub(bi.position, ri), rj.vadd(xj, rj), rj.vsub(bj.position, rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
            }
        };
        ...
        Narrowphase.prototype[Shape.types.SPHERE | Shape.types.BOX] = Narrowphase.prototype.sphereBox = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
            ...
            for (var R = si.radius, found = !1, side_ns = sphereBox_side_ns, side_ns1 = sphereBox_side_ns1, side_ns2 = sphereBox_side_ns2, side_h = null, side_penetrations = 0, side_dot1 = 0, side_dot2 = 0, side_distance = null, idx = 0, nsides = sides.length; idx !== nsides && !1 === found; idx++) {
                ...
                if (dot < h + R && dot > 0) {
                    ...
                    if (dot1 < h1 && dot1 > -h1 && dot2 < h2 && dot2 > -h2) {
                        ...
                        if ((null === side_distance || dist < side_distance) && (side_distance = dist, side_dot1 = dot1, side_dot2 = dot2, side_h = h, side_ns.copy(ns), side_ns1.copy(ns1), side_ns2.copy(ns2), side_penetrations++, justTest)) return !0
                    }
                }
            }
            ...
            for (var rj = v3pool.get(), sphere_to_corner = sphereBox_sphere_to_corner, j = 0; 2 !== j && !found; j++)
                for (var k = 0; 2 !== k && !found; k++)
                    for (var l = 0; 2 !== l && !found; l++)
                        if (rj.set(0, 0, 0), j ? rj.vadd(sides[0], rj) : rj.vsub(sides[0], rj), k ? rj.vadd(sides[1], rj) : rj.vsub(sides[1], rj), l ? rj.vadd(sides[2], rj) : rj.vsub(sides[2], rj), xj.vadd(rj, sphere_to_corner), sphere_to_corner.vsub(xi, sphere_to_corner), sphere_to_corner.norm2() < R * R) {
                            if (justTest) return !0;
            ...
            var edgeTangent = v3pool.get(),
                edgeCenter = v3pool.get(),
                orthogonal = (r = v3pool.get(), v3pool.get()),
                Nsides = (dist = v3pool.get(), sides.length);
            for (j = 0; j !== Nsides && !found; j++)
                for (k = 0; k !== Nsides && !found; k++)
                    if (j % 3 != k % 3) {
                        sides[k].cross(sides[j], edgeTangent), edgeTangent.normalize(), sides[j].vadd(sides[k], edgeCenter), r.copy(xi), r.vsub(edgeCenter, r), r.vsub(xj, r);
                        var orthonorm = r.dot(edgeTangent);
                        edgeTangent.mult(orthonorm, orthogonal);
                        for (l = 0; l === j % 3 || l === k % 3;) l++;
            ...
            for (var found = !1, nfaces = (i = 0, faces.length); i !== nfaces && !1 === found; i++) {
                ...
                if (xi.vsub(worldPoint, worldPointToSphere), penetration < 0 && worldPointToSphere.dot(worldNormal) > 0) {
                    ...
                    if (pointInPolygon(faceVerts, worldNormal, xi)) {
                        ...
                        j = 0;
                        for (var Nfaceverts = faceVerts.length; j !== Nfaceverts; j++) v3pool.release(faceVerts[j]);
                        return
                    }
                    for (j = 0; j !== face.length; j++) {
                        var v1 = v3pool.get(),
                            v2 = v3pool.get();
                        qj.vmult(verts[face[(j + 1) % face.length]], v1), qj.vmult(verts[face[(j + 2) % face.length]], v2), xj.vadd(v1, v1), xj.vadd(v2, v2);
                        ...
                        if (p.vsub(xi, xi_to_p), dot > 0 && dot * dot < edge.norm2() && xi_to_p.norm2() < R * R) {
                            if (justTest) return !0;
                            r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                            p.vsub(xj, r.rj), p.vsub(xi, r.ni), r.ni.normalize(), r.ni.mult(R, r.ri), r.rj.vadd(xj, r.rj), r.rj.vsub(bj.position, r.rj), r.ri.vadd(xi, r.ri), r.ri.vsub(bi.position, r.ri), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult);
                            for (j = 0, Nfaceverts = faceVerts.length; j !== Nfaceverts; j++) v3pool.release(faceVerts[j]);
                            return v3pool.release(v1), v3pool.release(v2), v3pool.release(p), v3pool.release(xi_to_p), void v3pool.release(v1_to_xi)
                        }
                        v3pool.release(v1), v3pool.release(v2), v3pool.release(p), v3pool.release(xi_to_p), v3pool.release(v1_to_xi)
                    }
                    for (j = 0, Nfaceverts = faceVerts.length; j !== Nfaceverts; j++) v3pool.release(faceVerts[j])
                }
            }
        ...
        Narrowphase.prototype[Shape.types.PLANE | Shape.types.BOX] = Narrowphase.prototype.planeBox = function (si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
            return sj.convexPolyhedronRepresentation.material = sj.material, sj.convexPolyhedronRepresentation.collisionResponse = sj.collisionResponse, sj.convexPolyhedronRepresentation.id = sj.id, this.planeConvex(si, sj.convexPolyhedronRepresentation, xi, xj, qi, qj, bi, bj, si, sj, justTest)
        };
        ...
        Narrowphase.prototype[Shape.types.PLANE | Shape.types.CONVEXPOLYHEDRON] = Narrowphase.prototype.planeConvex = function (planeShape, convexShape, planePosition, convexPosition, planeQuat, convexQuat, planeBody, convexBody, si, sj, justTest) {
            ...
            for (var numContacts = 0, relpos = planeConvex_relpos, i = 0; i !== convexShape.vertices.length; i++) {
                if (worldVertex.copy(convexShape.vertices[i]), convexQuat.vmult(worldVertex, worldVertex), convexPosition.vadd(worldVertex, worldVertex), worldVertex.vsub(planePosition, relpos), worldNormal.dot(relpos) <= 0) {
                    if (justTest) return !0;
                    var r = this.createContactEquation(planeBody, convexBody, planeShape, convexShape, si, sj),
                        projected = planeConvex_projected;
                    worldNormal.mult(worldNormal.dot(relpos), projected), worldVertex.vsub(projected, projected), projected.vsub(planePosition, r.ri), r.ni.copy(worldNormal), worldVertex.vsub(convexPosition, r.rj), r.ri.vadd(planePosition, r.ri), r.ri.vsub(planeBody.position, r.ri), r.rj.vadd(convexPosition, r.rj), r.rj.vsub(convexBody.position, r.rj), this.result.push(r), numContacts++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(r, this.frictionResult)
                }
            }
            ...
            if (!(xi.distanceTo(xj) > si.boundingSphereRadius + sj.boundingSphereRadius) && si.findSeparatingAxis(sj, xi, qi, xj, qj, sepAxis, faceListA, faceListB)) {
                ...
                for (var numContacts = 0, j = 0; j !== res.length; j++) {
                    ...
                    var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj),
                        ri = r.ri,
                        rj = r.rj;
                    sepAxis.negate(r.ni), res[j].normal.negate(q), q.mult(res[j].depth, q), res[j].point.vadd(q, ri), rj.copy(res[j].point), ri.vsub(xi, ri), rj.vsub(xj, rj), ri.vadd(xi, ri), ri.vsub(bi.position, ri), rj.vadd(xj, rj), rj.vsub(bj.position, rj), this.result.push(r), numContacts++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(r, this.frictionResult)
                }
                this.enableFrictionReduction && numContacts && this.createFrictionFromAverage(numContacts)
            }
        };
        ...
        Narrowphase.prototype[Shape.types.PLANE | Shape.types.PARTICLE] = Narrowphase.prototype.planeParticle = function (sj, si, xj, xi, qj, qi, bj, bi, rsi, rsj, justTest) {
            ...
            if (xi.vsub(bj.position, relpos), normal.dot(relpos) <= 0) {
                ...
                normal.mult(normal.dot(xi), projected), xi.vsub(projected, projected), r.rj.copy(projected), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
            }
        };
        ...
        Narrowphase.prototype[Shape.types.PARTICLE | Shape.types.SPHERE] = Narrowphase.prototype.sphereParticle = function (sj, si, xj, xi, qj, qi, bj, bi, rsi, rsj, justTest) {
            ...
            if (normal.set(0, 0, 1), xi.vsub(xj, normal), normal.norm2() <= sj.radius * sj.radius) {
                if (justTest) return !0;
                var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                normal.normalize(), r.rj.copy(normal), r.rj.mult(sj.radius, r.rj), r.ni.copy(normal), r.ni.negate(r.ni), r.ri.set(0, 0, 0), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
            }
        };
        var cqj = new Quaternion,
            convexParticle_local = new Vec3,
            convexParticle_penetratedFaceNormal = (new Vec3, new Vec3),
        ...
        Narrowphase.prototype[Shape.types.PARTICLE | Shape.types.CONVEXPOLYHEDRON] = Narrowphase.prototype.convexParticle = function (sj, si, xj, xi, qj, qi, bj, bi, rsi, rsj, justTest) {
            ...
            if (local.copy(xi), local.vsub(xj, local), qj.conjugate(cqj), cqj.vmult(local, local), sj.pointIsInside(local)) {
                ...
                for (var i = 0, nfaces = sj.faces.length; i !== nfaces; i++) {
                    ...
                    if (null === minPenetration || Math.abs(penetration) < Math.abs(minPenetration)) {
                        if (justTest) return !0;
                        minPenetration = penetration, penetratedFaceIndex = i, penetratedFaceNormal.copy(normal), 0
                    }
                }
                if (-1 !== penetratedFaceIndex) {
                    var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                    penetratedFaceNormal.mult(minPenetration, worldPenetrationVec), worldPenetrationVec.vadd(xi, worldPenetrationVec), worldPenetrationVec.vsub(xj, worldPenetrationVec), r.rj.copy(worldPenetrationVec), penetratedFaceNormal.negate(r.ni), r.ri.set(0, 0, 0);
                    var ri = r.ri,
                        rj = r.rj;
                    ri.vadd(xi, ri), ri.vsub(bi.position, ri), rj.vadd(xj, rj), rj.vsub(bj.position, rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
            ...
            return si.convexPolyhedronRepresentation.material = si.material, si.convexPolyhedronRepresentation.collisionResponse = si.collisionResponse, this.convexHeightfield(si.convexPolyhedronRepresentation, sj, xi, xj, qi, qj, bi, bj, si, sj, justTest)
        };
        ...
        Narrowphase.prototype[Shape.types.CONVEXPOLYHEDRON | Shape.types.HEIGHTFIELD] = Narrowphase.prototype.convexHeightfield = function (convexShape, hfShape, convexPos, hfPos, convexQuat, hfQuat, convexBody, hfBody, rsi, rsj, justTest) {
            ...
            if (!(iMaxX < 0 || iMaxY < 0 || iMinX > data.length || iMinY > data[0].length)) {
                iMinX < 0 && (iMinX = 0), iMaxX < 0 && (iMaxX = 0), iMinY < 0 && (iMinY = 0), iMaxY < 0 && (iMaxY = 0), iMinX >= data.length && (iMinX = data.length - 1), iMaxX >= data.length && (iMaxX = data.length - 1), iMaxY >= data[0].length && (iMaxY = data[0].length - 1), iMinY >= data[0].length && (iMinY = data[0].length - 1);
                var minMax = [];
                ...
                if (!(localConvexPos.z - radius > max || localConvexPos.z + radius < min))
                    for (var i = iMinX; i < iMaxX; i++)
                        for (var j = iMinY; j < iMaxY; j++) {
                            var intersecting = !1;
                            if (hfShape.getConvexTrianglePillar(i, j, !1), Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset), convexPos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + convexShape.boundingSphereRadius && (intersecting = this.convexConvex(convexShape, hfShape.pillarConvex, convexPos, worldPillarOffset, convexQuat, hfQuat, convexBody, hfBody, null, null, justTest, faceList, null)), justTest && intersecting) return !0;
                    ...
                    for (var result = this.result, i = iMinX; i < iMaxX; i++)
                        for (var j = iMinY; j < iMaxY; j++) {
                            var numContactsBefore = result.length,
                                intersecting = !1;
                            if (hfShape.getConvexTrianglePillar(i, j, !1), Transform.pointToWorldFrame(hfPos, hfQuat, hfShape.pillarOffset, worldPillarOffset), spherePos.distanceTo(worldPillarOffset) < hfShape.pillarConvex.boundingSphereRadius + sphereShape.boundingSphereRadius && (intersecting = this.sphereConvex(sphereShape, hfShape.pillarConvex, spherePos, worldPillarOffset, sphereQuat, hfQuat, sphereBody, hfBody, sphereShape, hfShape, justTest)), justTest && intersecting) return !0;
    ...
    60: [function (require, module, exports) {
        ...
        var Vec3 = require("../math/Vec3"),
            Quaternion = require("../math/Quaternion"),
            GSSolver = require("../solver/GSSolver"),
            Narrowphase = (require("../equations/ContactEquation"), require("../equations/FrictionEquation"), require("./Narrowphase")),
            EventTarget = require("../utils/EventTarget"),
            ArrayCollisionMatrix = require("../collision/ArrayCollisionMatrix"),
        ...
        function World(options) {
            options = options || {}, EventTarget.apply(this), this.dt = -1, this.allowSleep = !!options.allowSleep, this.contacts = [], this.frictionEquations = [], this.quatNormalizeSkip = void 0 !== options.quatNormalizeSkip ? options.quatNormalizeSkip : 0, this.quatNormalizeFast = void 0 !== options.quatNormalizeFast && options.quatNormalizeFast, this.time = 0, this.stepnumber = 0, this.default_dt = 1 / 60, this.nextId = 0, this.gravity = new Vec3, options.gravity && this.gravity.copy(options.gravity), this.broadphase = void 0 !== options.broadphase ? options.broadphase : new NaiveBroadphase, this.bodies = [], this.solver = void 0 !== options.solver ? options.solver : new GSSolver, this.constraints = [], this.narrowphase = new Narrowphase(this), this.collisionMatrix = new ArrayCollisionMatrix, this.collisionMatrixPrevious = new ArrayCollisionMatrix, this.bodyOverlapKeeper = new OverlapKeeper, this.shapeOverlapKeeper = new OverlapKeeper, this.materials = [], this.contactmaterials = [], this.contactMaterialTable = new TupleDictionary, this.defaultMaterial = new Material("default"), this.defaultContactMaterial = new ContactMaterial(this.defaultMaterial, this.defaultMaterial, {
                friction: .3,
                restitution: 0
        ...
        if (World.prototype.getContactMaterial = function (m1, m2) {
                ...
                return options.mode = Ray.ALL, options.from = from, options.to = to, options.callback = callback, tmpRay.intersectWorld(this, options)
            }, World.prototype.raycastAny = function (from, to, options, result) {
                return options.mode = Ray.ANY, options.from = from, options.to = to, options.result = result, tmpRay.intersectWorld(this, options)
            }, World.prototype.raycastClosest = function (from, to, options, result) {
                return options.mode = Ray.CLOSEST, options.from = from, options.to = to, options.result = result, tmpRay.intersectWorld(this, options)
                ...
                if (-1 !== idx) {
                    ...
                    this.collisionMatrix.setNumObjects(n), this.removeBodyEvent.body = body, delete this.idToBodyMap[body.id], this.dispatchEvent(this.removeBodyEvent)
                }
            }, World.prototype.removeBody = World.prototype.remove, World.prototype.getBodyById = function (id) {
            ...
            performance.timing && performance.timing.navigationStart && (nowOffset = performance.timing.navigationStart), performance.now = function () {
                return Date.now() - nowOffset
            }
        }
        new Vec3;
        World.prototype.step = function (dt, timeSinceLastCalled, maxSubSteps) {
            if (maxSubSteps = maxSubSteps || 10, 0 === (timeSinceLastCalled = timeSinceLastCalled || 0)) this.internalStep(dt), this.time += dt;
            else {
                this.accumulator += timeSinceLastCalled;
                for (var substeps = 0; this.accumulator >= dt && substeps < maxSubSteps;) this.internalStep(dt), this.accumulator -= dt, substeps++;
                for (var t = this.accumulator % dt / dt, j = 0; j !== this.bodies.length; j++) {
                    var b = this.bodies[j];
                    b.previousPosition.lerp(b.position, t, b.interpolatedPosition), b.previousQuaternion.slerp(b.quaternion, t, b.interpolatedQuaternion), b.previousQuaternion.normalize()
                }
        ...
        var additions, removals, beginContactEvent, endContactEvent, beginShapeContactEvent, endShapeContactEvent, World_step_postStepEvent = {
            ...
            World_step_p1 = [],
            World_step_p2 = [];
        new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Vec3, new Quaternion, new Quaternion, new Quaternion, new Vec3;
        World.prototype.internalStep = function (dt) {
            this.dt = dt;
            var profilingStart, contacts = this.contacts,
                p1 = World_step_p1,
                p2 = World_step_p2,
                N = this.numObjects(),
                bodies = this.bodies,
            ...
            i = 0;
            for (var Nsubsystems = this.subsystems.length; i !== Nsubsystems; i++) this.subsystems[i].update();
            doProfiling && (profilingStart = performance.now()), p1.length = 0, p2.length = 0, this.broadphase.collisionPairs(this, p1, p2), doProfiling && (profile.broadphase = performance.now() - profilingStart);
            var Nconstraints = constraints.length;
            for (i = 0; i !== Nconstraints; i++) {
                if (!(c = constraints[i]).collideConnected)
                    for (var j = p1.length - 1; j >= 0; j -= 1)(c.bodyA === p1[j] && c.bodyB === p2[j] || c.bodyB === p1[j] && c.bodyA === p2[j]) && (p1.splice(j, 1), p2.splice(j, 1))
            }
            ...
            this.frictionEquations.length = 0, this.narrowphase.getContacts(p1, p2, this, contacts, oldcontacts, this.frictionEquations, frictionEquationPool), doProfiling && (profile.narrowphase = performance.now() - profilingStart), doProfiling && (profilingStart = performance.now());
            for (i = 0; i < this.frictionEquations.length; i++) solver.addEquation(this.frictionEquations[i]);
            for (var ncontacts = contacts.length, k = 0; k !== ncontacts; k++) {
                var bi = (c = contacts[k]).bi,
                    bj = c.bj,
                    si = c.si,
                    sj = c.sj;
                (bi.material && bj.material && this.getContactMaterial(bi.material, bj.material) || this.defaultContactMaterial).friction;
                if (bi.material && bj.material && (bi.material.friction >= 0 && bj.material.friction >= 0 && bi.material.friction * bj.material.friction, bi.material.restitution >= 0 && bj.material.restitution >= 0 && (c.restitution = bi.material.restitution * bj.material.restitution)), solver.addEquation(c), bi.allowSleep && bi.type === Body.DYNAMIC && bi.sleepState === Body.SLEEPING && bj.sleepState === Body.AWAKE && bj.type !== Body.STATIC) bj.velocity.norm2() + bj.angularVelocity.norm2() >= 2 * Math.pow(bj.sleepSpeedLimit, 2) && (bi._wakeUpAfterNarrowphase = !0);
                if (bj.allowSleep && bj.type === Body.DYNAMIC && bj.sleepState === Body.SLEEPING && bi.sleepState === Body.AWAKE && bi.type !== Body.STATIC) bi.velocity.norm2() + bi.angularVelocity.norm2() >= 2 * Math.pow(bi.sleepSpeedLimit, 2) && (bj._wakeUpAfterNarrowphase = !0);
                this.collisionMatrix.set(bi, bj, !0), this.collisionMatrixPrevious.get(bi, bj) || (World_step_collideEvent.body = bj, World_step_collideEvent.contact = c, bi.dispatchEvent(World_step_collideEvent), World_step_collideEvent.body = bi, bj.dispatchEvent(World_step_collideEvent)), this.bodyOverlapKeeper.set(bi.id, bj.id), this.shapeOverlapKeeper.set(si.id, sj.id)
            }
            for (this.emitContactEvents(), doProfiling && (profile.makeContactConstraints = performance.now() - profilingStart, profilingStart = performance.now()), i = 0; i !== N; i++) {
                (bi = bodies[i])._wakeUpAfterNarrowphase && (bi.wakeUp(), bi._wakeUpAfterNarrowphase = !1)
            }
            Nconstraints = constraints.length;
            for (i = 0; i !== Nconstraints; i++) {
                var c;
                (c = constraints[i]).update();
                j = 0;
                for (var Neq = c.equations.length; j !== Neq; j++) {
                    var eq = c.equations[j];
                    solver.addEquation(eq)
                }
            }
            solver.solve(dt, this), doProfiling && (profile.solve = performance.now() - profilingStart), solver.removeAllEquations();
            var pow = Math.pow;
            for (i = 0; i !== N; i++) {
                if ((bi = bodies[i]).type & DYNAMIC) {
            ...
            for (this.clearForces(), this.broadphase.dirty = !0, doProfiling && (profile.integrate = performance.now() - profilingStart), this.time += dt, this.stepnumber += 1, this.dispatchEvent(World_step_postStepEvent), i = 0; i !== N; i++) {
            ...
            if ((hasBeginContact || hasEndContact) && this.bodyOverlapKeeper.getDiff(additions, removals), hasBeginContact) {
                for (var i = 0, l = additions.length; i < l; i += 2) beginContactEvent.bodyA = this.getBodyById(additions[i]), beginContactEvent.bodyB = this.getBodyById(additions[i + 1]), this.dispatchEvent(beginContactEvent);
                beginContactEvent.bodyA = beginContactEvent.bodyB = null
            }
            if (hasEndContact) {
                for (i = 0, l = removals.length; i < l; i += 2) endContactEvent.bodyA = this.getBodyById(removals[i]), endContactEvent.bodyB = this.getBodyById(removals[i + 1]), this.dispatchEvent(endContactEvent);
            ...
            if ((hasBeginShapeContact || hasEndShapeContact) && this.shapeOverlapKeeper.getDiff(additions, removals), hasBeginShapeContact) {
                for (i = 0, l = additions.length; i < l; i += 2) {
                    var shapeA = this.getShapeById(additions[i]),
                        shapeB = this.getShapeById(additions[i + 1]);
                    beginShapeContactEvent.shapeA = shapeA, beginShapeContactEvent.shapeB = shapeB, beginShapeContactEvent.bodyA = shapeA.body, beginShapeContactEvent.bodyB = shapeB.body, this.dispatchEvent(beginShapeContactEvent)
                }
                beginShapeContactEvent.bodyA = beginShapeContactEvent.bodyB = beginShapeContactEvent.shapeA = beginShapeContactEvent.shapeB = null
            }
            if (hasEndShapeContact) {
                for (i = 0, l = removals.length; i < l; i += 2) shapeA = this.getShapeById(removals[i]), shapeB = this.getShapeById(removals[i + 1]), endShapeContactEvent.shapeA = shapeA, endShapeContactEvent.shapeB = shapeB, endShapeContactEvent.bodyA = shapeA.body, endShapeContactEvent.bodyB = shapeB.body, this.dispatchEvent(endShapeContactEvent);
    ...
    61: [function (require, module, exports) {
        ...
        exports.createCollisionShapes = function (root, options) {
            ...
            options.type = TYPE.BOX, _setOptions(options), options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root), options.minHalfExtent, options.maxHalfExtent));
            ...
            return Ammo.destroy(btHalfExtents), _finishCollisionShape(collisionShape, options, _computeScale(root, options)), collisionShape
        }, exports.createCylinderShape = function (root, options) {
            options.type = TYPE.CYLINDER, _setOptions(options), options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root), options.minHalfExtent, options.maxHalfExtent));
            const btHalfExtents = new Ammo.btVector3(options.halfExtents.x, options.halfExtents.y, options.halfExtents.z),
                collisionShape = (() => {
            ...
            options.type = TYPE.CAPSULE, _setOptions(options), options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root), options.minHalfExtent, options.maxHalfExtent));
            const {
                x: x,
                y: y,
                z: z
            ...
            return _finishCollisionShape(collisionShape, options, _computeScale(root, options)), collisionShape
        }, exports.createConeShape = function (root, options) {
            options.type = TYPE.CONE, _setOptions(options), options.fit === FIT.ALL && (options.halfExtents = _computeHalfExtents(root, _computeBounds(root), options.minHalfExtent, options.maxHalfExtent));
            const {
                x: x,
                y: y,
                z: z
            ...
            let radius;
            options.type = TYPE.SPHERE, radius = options.fit !== FIT.MANUAL || isNaN(options.sphereRadius) ? _computeRadius(root, _computeBounds(root)) : options.sphereRadius;
            ...
            return function (root, options) {
                if (options.type = TYPE.HULL, _setOptions(options), options.fit === FIT.MANUAL) return console.warn("cannot use fit: manual with type: hull"), null;
                const bounds = _computeBounds(root),
                    btVertex = new Ammo.btVector3,
                    originalHull = new Ammo.btConvexHullShape;
                ...
                _iterateGeometries(root, (geo, transform) => {
                    ...
                    for (let i = 0; i < components.length; i += 3) Math.random() <= p && (vertex.set(components[i], components[i + 1], components[i + 2]).applyMatrix4(transform).sub(center), btVertex.setValue(vertex.x, vertex.y, vertex.z), originalHull.addPoint(btVertex, i === components.length - 3))
                });
                let collisionShape = originalHull;
                if (originalHull.getNumVertices() >= 100) {
                    const shapeHull = new Ammo.btShapeHull(originalHull);
                    shapeHull.buildHull(options.margin), Ammo.destroy(originalHull), collisionShape = new Ammo.btConvexHullShape(Ammo.getPointer(shapeHull.getVertexPointer()), shapeHull.numVertices()), Ammo.destroy(shapeHull)
                }
                return Ammo.destroy(btVertex), _finishCollisionShape(collisionShape, options, _computeScale(root, options)), collisionShape
            }
            ...
            return function (root, options) {
                ...
                let vertexCount = 0,
                    triCount = 0;
                center.addVectors(bounds.max, bounds.min).multiplyScalar(.5), _iterateGeometries(root, geo => {
                ...
                options.hasOwnProperty("compacityWeight") && hacd.SetCompacityWeight(options.compacityWeight), options.hasOwnProperty("volumeWeight") && hacd.SetVolumeWeight(options.volumeWeight), options.hasOwnProperty("nClusters") && hacd.SetNClusters(options.nClusters), options.hasOwnProperty("nVerticesPerCH") && hacd.SetNVerticesPerCH(options.nVerticesPerCH), options.hasOwnProperty("concavity") && hacd.SetConcavity(options.concavity);
                const points = Ammo._malloc(3 * vertexCount * 8),
                    triangles = Ammo._malloc(3 * triCount * 4);
                hacd.SetPoints(points), hacd.SetTriangles(triangles), hacd.SetNPoints(vertexCount), hacd.SetNTriangles(triCount);
                const pptr = points / 8,
                    tptr = triangles / 4;
                _iterateGeometries(root, (geo, transform) => {
                    const components = geo.attributes.position.array,
                        indices = geo.index ? geo.index.array : null;
                    for (let i = 0; i < components.length; i += 3) v.set(components[i + 0], components[i + 1], components[i + 2]).applyMatrix4(transform).sub(center), Ammo.HEAPF64[pptr + i + 0] = v.x, Ammo.HEAPF64[pptr + i + 1] = v.y, Ammo.HEAPF64[pptr + i + 2] = v.z;
                    if (indices)
                        for (let i = 0; i < indices.length; i++) Ammo.HEAP32[tptr + i] = indices[i];
                    else
                        for (let i = 0; i < components.length / 3; i++) Ammo.HEAP32[tptr + i] = i
                }), hacd.Compute();
                ...
                for (let i = 0; i < nClusters; i++) {
                    ...
                    const nPoints = hacd.GetNPointsCH(i),
                        nTriangles = hacd.GetNTrianglesCH(i),
                        hullPoints = Ammo._malloc(3 * nPoints * 8),
                        hullTriangles = Ammo._malloc(3 * nTriangles * 4);
                    hacd.GetCH(i, hullPoints, hullTriangles);
                    const pptr = hullPoints / 8;
                    for (let pi = 0; pi < nPoints; pi++) {
                        const btVertex = new Ammo.btVector3,
                            px = Ammo.HEAPF64[pptr + 3 * pi + 0],
                            py = Ammo.HEAPF64[pptr + 3 * pi + 1],
                            pz = Ammo.HEAPF64[pptr + 3 * pi + 2];
                        btVertex.setValue(px, py, pz), hull.addPoint(btVertex, pi === nPoints - 1), Ammo.destroy(btVertex)
                    }
            ...
            return function (root, options) {
                ...
                _iterateGeometries(root, (geo, transform) => {
                    const components = geo.attributes.position.array,
                        indices = geo.index ? geo.index.array : null;
                    for (let i = 0; i < components.length; i += 3) v.set(components[i + 0], components[i + 1], components[i + 2]).applyMatrix4(transform).sub(center), Ammo.HEAPF64[pptr + 0] = v.x, Ammo.HEAPF64[pptr + 1] = v.y, Ammo.HEAPF64[pptr + 2] = v.z, pptr += 3;
                    if (indices)
                        for (let i = 0; i < indices.length; i++) Ammo.HEAP32[tptr] = indices[i], tptr++;
                    else
                        for (let i = 0; i < components.length / 3; i++) Ammo.HEAP32[tptr] = i, tptr++
                }), vhacd.Compute(points, 3, vertexCount, triangles, 3, triCount, params), Ammo._free(points), Ammo._free(triangles);
                const nHulls = vhacd.GetNConvexHulls(),
                    shapes = [],
                    ch = new Ammo.ConvexHull;
                for (let i = 0; i < nHulls; i++) {
                    vhacd.GetConvexHull(i, ch);
                    const nPoints = ch.get_m_nPoints(),
                        hull = (ch.get_m_points(), new Ammo.btConvexHullShape);
                    hull.setMargin(options.margin);
                    for (let pi = 0; pi < nPoints; pi++) {
                        const btVertex = new Ammo.btVector3,
                            px = ch.get_m_points(3 * pi + 0),
                            py = ch.get_m_points(3 * pi + 1),
                            pz = ch.get_m_points(3 * pi + 2);
                        btVertex.setValue(px, py, pz), hull.addPoint(btVertex, pi === nPoints - 1), Ammo.destroy(btVertex)
                    }
                    _finishCollisionShape(hull, options, scale), shapes.push(hull)
                }
            ...
            return function (root, options) {
                if (options.type = TYPE.MESH, _setOptions(options), options.fit === FIT.MANUAL) return console.warn("cannot use fit: manual with type: mesh"), null;
                const scale = _computeScale(root, options),
                    bta = new Ammo.btVector3,
                    btb = new Ammo.btVector3,
                    btc = new Ammo.btVector3,
                    triMesh = new Ammo.btTriangleMesh(!0, !1);
                _iterateGeometries(root, (geo, transform) => {
                    const components = geo.attributes.position.array;
                    if (geo.index)
                        for (let i = 0; i < geo.index.count; i += 3) {
                            const ai = 3 * geo.index.array[i],
                                bi = 3 * geo.index.array[i + 1],
                                ci = 3 * geo.index.array[i + 2];
                            va.set(components[ai], components[ai + 1], components[ai + 2]).applyMatrix4(transform), vb.set(components[bi], components[bi + 1], components[bi + 2]).applyMatrix4(transform), vc.set(components[ci], components[ci + 1], components[ci + 2]).applyMatrix4(transform), bta.setValue(va.x, va.y, va.z), btb.setValue(vb.x, vb.y, vb.z), btc.setValue(vc.x, vc.y, vc.z), triMesh.addTriangle(bta, btb, btc, !1)
                        } else
                            for (let i = 0; i < components.length; i += 9) va.set(components[i + 0], components[i + 1], components[i + 2]).applyMatrix4(transform), vb.set(components[i + 3], components[i + 4], components[i + 5]).applyMatrix4(transform), vc.set(components[i + 6], components[i + 7], components[i + 8]).applyMatrix4(transform), bta.setValue(va.x, va.y, va.z), btb.setValue(vb.x, vb.y, vb.z), btc.setValue(vc.x, vc.y, vc.z), triMesh.addTriangle(bta, btb, btc, !1)
                });
                ...
                return collisionShape.resources = [triMesh], Ammo.destroy(bta), Ammo.destroy(btb), Ammo.destroy(btc), _finishCollisionShape(collisionShape, options), collisionShape
            }
        }();
        const _finishCollisionShape = function (collisionShape, options, scale) {
                collisionShape.type = options.type, collisionShape.setMargin(options.margin), collisionShape.destroy = (() => {
                    for (let res of collisionShape.resources || []) Ammo.destroy(res);
                    Ammo.destroy(collisionShape)
                });
                const localTransform = new Ammo.btTransform,
                    rotation = new Ammo.btQuaternion;
                if (localTransform.setIdentity(), localTransform.getOrigin().setValue(options.offset.x, options.offset.y, options.offset.z), rotation.setValue(options.orientation.x, options.orientation.y, options.orientation.z, options.orientation.w), localTransform.setRotation(rotation), Ammo.destroy(rotation), scale) {
                    const localScale = new Ammo.btVector3(scale.x, scale.y, scale.z);
            ...
            _iterateGeometries = function () {
                ...
                return function (root, cb) {
                    inverse.getInverse(root.matrixWorld), root.traverse(mesh => {
                        !mesh.isMesh || THREE.Sky && mesh.__proto__ == THREE.Sky.prototype || (mesh === root ? transform.identity() : (hasUpdateMatricesFunction && mesh.updateMatrices(), transform.multiplyMatrices(inverse, mesh.matrixWorld)), cb(mesh.geometry.isBufferGeometry ? mesh.geometry : bufferGeometry.fromGeometry(mesh.geometry), transform))
                    })
                }
            }(),
            _computeScale = function (root, options) {
                const scale = new THREE.Vector3(1, 1, 1);
                return options.fit === FIT.ALL && scale.setFromMatrixScale(root.matrixWorld), scale
            },
            _computeRadius = function () {
                ...
                return function (root, bounds) {
                    ...
                    return _iterateGeometries(root, (geo, transform) => {
                        const components = geo.attributes.position.array;
            ...
            _computeBounds = function () {
                ...
                return function (root) {
                    ...
                    let minX = 1 / 0,
                        ...
                        maxY = -1 / 0,
                        maxZ = -1 / 0;
                    return bounds.min.set(0, 0, 0), bounds.max.set(0, 0, 0), _iterateGeometries(root, (geo, transform) => {
                        const components = geo.attributes.position.array;
                        for (let i = 0; i < components.length; i += 3) v.set(components[i], components[i + 1], components[i + 2]).applyMatrix4(transform), v.x < minX && (minX = v.x), v.y < minY && (minY = v.y), v.z < minZ && (minZ = v.z), v.x > maxX && (maxX = v.x), v.y > maxY && (maxY = v.y), v.z > maxZ && (maxZ = v.z)
                    }), bounds.min.set(minX, minY, minZ), bounds.max.set(maxX, maxY, maxZ), bounds
                }
            }()
    }, {}],
    62: [function (require, module, exports) {
        var CANNON = require("cannon"),
            ...
            mesh2shape = function (object, options) {
                var geometry;
                if ((options = options || {}).type === Type.BOX) return createBoundingBoxShape(object);
                if (options.type === Type.CYLINDER) return function (object, options) {
                    var shape, height, radius, box = new THREE.Box3,
                        axes = ["x", "y", "z"],
                        majorAxis = options.cylinderAxis || "y",
                        minorAxes = axes.splice(axes.indexOf(majorAxis), 1) && axes;
                    return box.setFromObject(object), isFinite(box.min.lengthSq()) ? (height = box.max[majorAxis] - box.min[majorAxis], radius = .5 * Math.max(box.max[minorAxes[0]] - box.min[minorAxes[0]], box.max[minorAxes[1]] - box.min[minorAxes[1]]), (shape = new CANNON.Cylinder(radius, radius, height, 12))._type = CANNON.Shape.types.CYLINDER, shape.radiusTop = radius, shape.radiusBottom = radius, shape.height = height, shape.numSegments = 12, shape.orientation = new CANNON.Quaternion, shape.orientation.setFromEuler("y" === majorAxis ? PI_2 : 0, "z" === majorAxis ? PI_2 : 0, 0, "XYZ").normalize(), shape) : null
                }(object, options);
                if (options.type === Type.SPHERE) return function (object, options) {
                    if (options.sphereRadius) return new CANNON.Sphere(options.sphereRadius);
                    var geometry = getGeometry(object);
                    return geometry ? (geometry.computeBoundingSphere(), new CANNON.Sphere(geometry.boundingSphere.radius)) : null
                }(object, options);
                if (options.type === Type.HULL) return function (object) {
                    var i, vertices, faces, hull, geometry = getGeometry(object);
                    if (!geometry || !geometry.vertices.length) return null;
                    for (i = 0; i < geometry.vertices.length; i++) geometry.vertices[i].x += 1e-4 * (Math.random() - .5), geometry.vertices[i].y += 1e-4 * (Math.random() - .5), geometry.vertices[i].z += 1e-4 * (Math.random() - .5);
                    for (hull = quickhull(geometry), vertices = new Array(hull.vertices.length), i = 0; i < hull.vertices.length; i++) vertices[i] = new CANNON.Vec3(hull.vertices[i].x, hull.vertices[i].y, hull.vertices[i].z);
                    for (faces = new Array(hull.faces.length), i = 0; i < hull.faces.length; i++) faces[i] = [hull.faces[i].a, hull.faces[i].b, hull.faces[i].c];
                    return new CANNON.ConvexPolyhedron(vertices, faces)
                }(object);
                if (options.type === Type.MESH) return (geometry = getGeometry(object)) ? function (geometry) {
                    var indices, vertices = getVertices(geometry);
                    return vertices.length ? (indices = Object.keys(vertices).map(Number), new CANNON.Trimesh(vertices, indices)) : null
                }(geometry) : null;
                if (options.type) throw new Error('[CANNON.mesh2shape] Invalid type "%s".', options.type);
                if (!(geometry = getGeometry(object))) return null;
                switch (geometry.metadata ? geometry.metadata.type : geometry.type) {
                    ...
                    default:
                        return console.warn('Unrecognized geometry: "%s". Using bounding box as shape.', geometry.type), createBoxShape(geometry)
                }
            };

        function createBoxShape(geometry) {
            if (!getVertices(geometry).length) return null;
            geometry.computeBoundingBox();
            var box = geometry.boundingBox;
        ...
        function getGeometry(object) {
            ...
            if (0 === meshes.length) return null;
            if (1 === meshes.length) {
                var position = new THREE.Vector3,
                    quaternion = new THREE.Quaternion,
                    scale = new THREE.Vector3;
                return meshes[0].geometry.isBufferGeometry ? meshes[0].geometry.attributes.position && meshes[0].geometry.attributes.position.itemSize > 2 && tmp.fromBufferGeometry(meshes[0].geometry) : tmp = meshes[0].geometry.clone(), tmp.metadata = meshes[0].geometry.metadata, meshes[0].updateMatrixWorld(), meshes[0].matrixWorld.decompose(position, quaternion, scale), tmp.scale(scale.x, scale.y, scale.z)
            }
            for (; mesh = meshes.pop();)
                if (mesh.updateMatrixWorld(), mesh.geometry.isBufferGeometry) {
                    if (mesh.geometry.attributes.position && mesh.geometry.attributes.position.itemSize > 2) {
                        var tmpGeom = new THREE.Geometry;
                        tmpGeom.fromBufferGeometry(mesh.geometry), combined.merge(tmpGeom, mesh.matrixWorld), tmpGeom.dispose()
                    }
                } else combined.merge(mesh.geometry, mesh.matrixWorld);
            return (matrix = new THREE.Matrix4).scale(object.scale), combined.applyMatrix(matrix), combined
        }

        function getVertices(geometry) {
            return geometry.attributes || (geometry = (new THREE.BufferGeometry).fromGeometry(geometry)), (geometry.attributes.position || {}).array || []
        }
        mesh2shape.Type = Type, module.exports = CANNON.mesh2shape = mesh2shape
    }, {
        "./lib/THREE.quickhull": 63,
        cannon: 5
    }],
    63: [function (require, module, exports) {
        module.exports = function () {
            var NUM_POINTS, extremes, dcur, j, v0, v1, v2, v3, N, D, ab, ac, suba, subb, normal, diff, subaA, subaB, subC, faces = [],
                faceStack = [],
                max = 0;
            var norm = function () {
                ...
                return function (a, b, c) {
                    return ca.subVectors(c, a), ba.subVectors(b, a), N.crossVectors(ca, ba), N.normalize()
                }
            }();

            function getNormal(face, points) {
                if (void 0 !== face.normal) return face.normal;
                var p0 = points[face[0]],
                    p1 = points[face[1]],
                    p2 = points[face[2]];
                return ab.subVectors(p1, p0), ac.subVectors(p2, p0), normal.crossVectors(ac, ab), normal.normalize(), face.normal = normal.clone()
            }
            ...
            function assignPoints(face, pointset, points) {
                ...
                pointset.sort(function (aItem, bItem) {
                    return dots[aItem.x / 3] = void 0 !== dots[aItem.x / 3] ? dots[aItem.x / 3] : norm.dot(suba.subVectors(aItem, p0)), dots[bItem.x / 3] = void 0 !== dots[bItem.x / 3] ? dots[bItem.x / 3] : norm.dot(subb.subVectors(bItem, p0)), dots[aItem.x / 3] - dots[bItem.x / 3]
                });
            ...
            function cull(face, points) {
                for (var currentFace, i = faces.length, visibleFaces = [face], apex = points.indexOf(face.visiblePoints.pop()); i-- > 0;)(currentFace = faces[i]) !== face && getNormal(currentFace, points).dot(diff.subVectors(points[apex], points[currentFace[0]])) > 0 && visibleFaces.push(currentFace);
                var compareFace, nextIndex, a, b, j = i = visibleFaces.length,
                    hasOneVisibleFace = 1 === i,
                    perimeter = [],
                    edgeIndex = 0,
                    allPoints = [];
                visibleFaces[0][0], visibleFaces[0][1], visibleFaces[0][1], visibleFaces[0][2], visibleFaces[0][2], visibleFaces[0][0];
                if (1 === visibleFaces.length) perimeter = [(currentFace = visibleFaces[0])[0], currentFace[1], currentFace[1], currentFace[2], currentFace[2], currentFace[0]], faceStack.indexOf(currentFace) > -1 && faceStack.splice(faceStack.indexOf(currentFace), 1), currentFace.visiblePoints && (allPoints = allPoints.concat(currentFace.visiblePoints)), faces.splice(faces.indexOf(currentFace), 1);
                else
                    for (; i-- > 0;) {
                        var isSharedEdge;
                        for (currentFace = visibleFaces[i], faceStack.indexOf(currentFace) > -1 && faceStack.splice(faceStack.indexOf(currentFace), 1), currentFace.visiblePoints && (allPoints = allPoints.concat(currentFace.visiblePoints)), faces.splice(faces.indexOf(currentFace), 1), cEdgeIndex = 0; cEdgeIndex < 3;) {
                            for (isSharedEdge = !1, j = visibleFaces.length, a = currentFace[cEdgeIndex], b = currentFace[(cEdgeIndex + 1) % 3]; j-- > 0 && !isSharedEdge;)
                                if (edgeIndex = 0, (compareFace = visibleFaces[j]) !== currentFace)
                                    for (; edgeIndex < 3 && !isSharedEdge;) nextIndex = edgeIndex + 1, isSharedEdge = compareFace[edgeIndex] === a && compareFace[nextIndex % 3] === b || compareFace[edgeIndex] === b && compareFace[nextIndex % 3] === a, edgeIndex++;
                            isSharedEdge && !hasOneVisibleFace || (perimeter.push(a), perimeter.push(b)), cEdgeIndex++
                        }
                    }
                i = 0;
                for (var f, l = perimeter.length / 2; i < l;) assignPoints(f = [perimeter[2 * i + 1], apex, perimeter[2 * i]], allPoints, points), faces.push(f), void 0 !== f.visiblePoints && faceStack.push(f), i++
            }
            var distSqPointSegment = function () {
                ...
                return function (a, b, c) {
                    ab.subVectors(b, a), ac.subVectors(c, a), bc.subVectors(c, b);
                    var e = ac.dot(ab);
            ...
            return function (geometry) {
                ...
                subaA.subVectors(v1, v0).normalize(), subaB.subVectors(v2, v0).normalize(), subC.subVectors(v3, v0).normalize(), subC.dot((new THREE.Vector3).crossVectors(subaB, subaA)) < 0 && (tetrahedron[0].reverse(), tetrahedron[1].reverse(), tetrahedron[2].reverse(), tetrahedron[3].reverse());
                var pointsCloned = points.slice();
                pointsCloned.splice(pointsCloned.indexOf(v0), 1), pointsCloned.splice(pointsCloned.indexOf(v1), 1), pointsCloned.splice(pointsCloned.indexOf(v2), 1), pointsCloned.splice(pointsCloned.indexOf(v3), 1);
                for (var i = tetrahedron.length; i-- > 0;) assignPoints(tetrahedron[i], pointsCloned, points), void 0 !== tetrahedron[i].visiblePoints && faceStack.push(tetrahedron[i]), faces.push(tetrahedron[i]);
                ! function (points) {
                    for (; faceStack.length > 0;) cull(faceStack.shift(), points)
                }(points);
                for (var ll = faces.length; ll-- > 0;) geometry.faces[ll] = new THREE.Face3(faces[ll][2], faces[ll][1], faces[ll][0], faces[ll].normal);
                return geometry.normalsNeedUpdate = !0, geometry
            }
        }()
    }, {}],
    ...
    65: [function (require, module, exports) {
        ...
        module.exports = AFRAME.registerComponent("ammo-constraint", {
            ...
            remove: function () {
                this.constraint && (this.system.removeConstraint(this.constraint), this.constraint = null)
            },
            update: function () {
                const el = this.el,
                    data = this.data;
                this.remove(), el.body && data.target.body ? (this.constraint = this.createConstraint(), this.system.addConstraint(this.constraint)) : (el.body ? data.target : el).addEventListener("body-loaded", this.update.bind(this, {}), {
                    once: !0
                })
            },
            createConstraint: function () {
                ...
                const data = this.data,
                    ...
                    bodyTransform = body.getCenterOfMassTransform().inverse().op_mul(targetBody.getWorldTransform()),
                    targetTransform = new Ammo.btTransform;
                switch (targetTransform.setIdentity(), data.type) {
                    case CONSTRAINT.LOCK: {
                        ...
                        constraint.setLinearLowerLimit(zero), constraint.setLinearUpperLimit(zero), constraint.setAngularLowerLimit(zero), constraint.setAngularUpperLimit(zero), Ammo.destroy(zero);
                        break
                    }
                    case CONSTRAINT.FIXED:
                        bodyTransform.setRotation(body.getWorldTransform().getRotation()), targetTransform.setRotation(targetBody.getWorldTransform().getRotation()), constraint = new Ammo.btFixedConstraint(body, targetBody, bodyTransform, targetTransform);
                        break;
                    ...
                    case CONSTRAINT.SLIDER:
                        (constraint = new Ammo.btSliderConstraint(body, targetBody, bodyTransform, targetTransform, !0)).setLowerLinLimit(-1), constraint.setUpperLinLimit(1);
                        break;
                    case CONSTRAINT.HINGE: {
                        const pivot = new Ammo.btVector3(data.pivot.x, data.pivot.y, data.pivot.z),
                            targetPivot = new Ammo.btVector3(data.targetPivot.x, data.targetPivot.y, data.targetPivot.z),
                            axis = new Ammo.btVector3(data.axis.x, data.axis.y, data.axis.z),
                            targetAxis = new Ammo.btVector3(data.targetAxis.x, data.targetAxis.y, data.targetAxis.z);
                        constraint = new Ammo.btHingeConstraint(body, targetBody, pivot, targetPivot, axis, targetAxis, !0), Ammo.destroy(pivot), Ammo.destroy(targetPivot), Ammo.destroy(axis), Ammo.destroy(targetAxis);
                        break
                    }
                    case CONSTRAINT.CONE_TWIST: {
                        const pivotTransform = new Ammo.btTransform;
                        pivotTransform.setIdentity(), pivotTransform.getOrigin().setValue(data.targetPivot.x, data.targetPivot.y, data.targetPivot.z), constraint = new Ammo.btConeTwistConstraint(body, pivotTransform), Ammo.destroy(pivotTransform);
                        break
                    }
                    case CONSTRAINT.POINT_TO_POINT: {
                        const pivot = new Ammo.btVector3(data.pivot.x, data.pivot.y, data.pivot.z),
                            targetPivot = new Ammo.btVector3(data.targetPivot.x, data.targetPivot.y, data.targetPivot.z);
                        constraint = new Ammo.btPoint2PointConstraint(body, targetBody, pivot, targetPivot), Ammo.destroy(pivot), Ammo.destroy(targetPivot);
                        break
                    }
                    default:
                        throw new Error("[constraint] Unexpected type: " + data.type)
                }
                return Ammo.destroy(bodyTransform), Ammo.destroy(targetTransform), constraint
            }
        })
    }, {
        "../constants": 76
    ...
    66: [function (require, module, exports) {
        ...
        const threeToAmmo = require("three-to-ammo"),
            ...
            TYPE = CONSTANTS.TYPE,
            ACTIVATION_STATES = (CONSTANTS.FIT, [ACTIVATION_STATE.ACTIVE_TAG, ACTIVATION_STATE.ISLAND_SLEEPING, ACTIVATION_STATE.WANTS_DEACTIVATION, ACTIVATION_STATE.DISABLE_DEACTIVATION, ACTIVATION_STATE.DISABLE_SIMULATION]),
            RIGID_BODY_FLAGS_NONE = 0,
            RIGID_BODY_FLAGS_DISABLE_WORLD_GRAVITY = 1;
        ...
        let AmmoBody = {
            ...
            init: function () {
                this.system = this.el.sceneEl.systems.physics, this.shapeComponents = [], "" === this.data.loadedEvent ? this.loadedEventFired = !0 : this.el.addEventListener(this.data.loadedEvent, () => {
            ...
            initBody: function () {
                ...
                return function () {
                    ...
                    almostEqualsBtVector3(.001, gravity, this.system.driver.physicsWorld.getGravity()) || (this.body.setGravity(gravity), this.body.setFlags(RIGID_BODY_FLAGS_DISABLE_WORLD_GRAVITY)), Ammo.destroy(gravity), this.updateCollisionFlags(), this.el.body = this.body, this.body.el = el, this.isLoaded = !0, this.el.emit("body-loaded", {
                        body: this.el.body
                    }), this._addToSystem()
                }
            }(),
            ...
            _updateShapes: function () {
                ...
                return function () {
                    let updated = !1;
                    const obj = this.el.object3D;
                    if (this.data.scaleAutoUpdate && this.prevScale && !almostEqualsVector3(.001, obj.scale, this.prevScale) && (this.prevScale.copy(obj.scale), updated = !0, this.localScaling.setValue(this.prevScale.x, this.prevScale.y, this.prevScale.z), this.compoundShape.setLocalScaling(this.localScaling)), this.shapeComponentsChanged) {
                        ...
                        for (let i = 0; i < this.shapeComponents.length; i++) {
                            ...
                            for (let j = 0; j < collisionShapes.length; j++) {
                                ...
                                collisionShape.added || (this.compoundShape.addChildShape(collisionShape.localTransform, collisionShape), collisionShape.added = !0)
                            }
                        }
                    ...
                    if (this.system.debug && (updated || !this.polyHedralFeaturesInitialized)) {
                        for (let i = 0; i < this.shapeComponents.length; i++) {
                            ...
                            for (let j = 0; j < collisionShapes.length; j++) {
                                const collisionShape = collisionShapes[j]; - 1 !== needsPolyhedralInitialization.indexOf(collisionShape.type) && collisionShape.initializePolyhedralFeatures(0)
                            }
                        }
            ...
            _createCollisionShape: function (shapeComponent) {
                const data = shapeComponent.data,
                    collisionShapes = threeToAmmo.createCollisionShapes(shapeComponent.getMesh(), data);
            ...
            _addToSystem: function () {
                this.addedToSystem || (this.system.addBody(this.body, this.data.collisionFilterGroup, this.data.collisionFilterMask), this.data.emitCollisionEvents && this.system.driver.addEventListener(this.body), this.system.addComponent(this), this.addedToSystem = !0)
            },
            pause: function () {
                this.addedToSystem && (this.system.removeComponent(this), this.system.removeBody(this.body), this.addedToSystem = !1)
            },
            update: function (prevData) {
                if (this.isLoaded) {
                    if (!this.hasUpdated) return void(this.hasUpdated = !0);
                    const data = this.data;
                    if (prevData.type === data.type && prevData.disableCollision === data.disableCollision || this.updateCollisionFlags(), prevData.activationState !== data.activationState && (this.body.forceActivationState(ACTIVATION_STATES.indexOf(data.activationState) + 1), data.activationState === ACTIVATION_STATE.ACTIVE_TAG && this.body.activate(!0)), prevData.collisionFilterGroup !== data.collisionFilterGroup || prevData.collisionFilterMask !== data.collisionFilterMask) {
                        const broadphaseProxy = this.body.getBroadphaseProxy();
                        broadphaseProxy.set_m_collisionFilterGroup(data.collisionFilterGroup), broadphaseProxy.set_m_collisionFilterMask(data.collisionFilterMask), this.system.driver.broadphase.getOverlappingPairCache().removeOverlappingPairsContainingProxy(broadphaseProxy, this.system.driver.dispatcher)
                    }
                    if (prevData.linearDamping == data.linearDamping && prevData.angularDamping == data.angularDamping || this.body.setDamping(data.linearDamping, data.angularDamping), !almostEqualsVector3(.001, prevData.gravity, data.gravity)) {
                        const gravity = new Ammo.btVector3(data.gravity.x, data.gravity.y, data.gravity.z);
                        almostEqualsBtVector3(.001, gravity, this.system.driver.physicsWorld.getGravity()) ? this.body.setFlags(RIGID_BODY_FLAGS_NONE) : this.body.setFlags(RIGID_BODY_FLAGS_DISABLE_WORLD_GRAVITY), this.body.setGravity(gravity), Ammo.destroy(gravity)
                    }
                    if (prevData.linearSleepingThreshold == data.linearSleepingThreshold && prevData.angularSleepingThreshold == data.angularSleepingThreshold || this.body.setSleepingThresholds(data.linearSleepingThreshold, data.angularSleepingThreshold), !almostEqualsVector3(.001, prevData.angularFactor, data.angularFactor)) {
                        const angularFactor = new Ammo.btVector3(data.angularFactor.x, data.angularFactor.y, data.angularFactor.z);
                        this.body.setAngularFactor(angularFactor), Ammo.destroy(angularFactor)
                    }
                }
            ...
            syncToPhysics: function () {
                ...
                return function () {
                    ...
                    if (!this.body) return;
                    this.motionState.getWorldTransform(this.msTransform), parentEl.isScene ? (v.copy(el.object3D.position), q.copy(el.object3D.quaternion)) : (el.object3D.getWorldPosition(v), el.object3D.getWorldQuaternion(q));
                    ...
                    q2.set(quaternion.x(), quaternion.y(), quaternion.z(), quaternion.w()), almostEqualsVector3(.001, v, v2) && function (epsilon, u, v) {
            ...
            updateMass: function () {
                const shape = this.body.getCollisionShape(),
                    mass = this.data.type === TYPE.DYNAMIC ? this.data.mass : 0;
                shape.calculateLocalInertia(mass, this.localInertia), this.body.setMassProps(mass, this.localInertia), this.body.updateInertiaTensor()
            },
        ...
        var q, v, Body = {
            ...
            initBody: function () {
                ...
                if (this.body = new CANNON.Body({
                    ...
                    this.body.addShape(shape, shape.offset, shape.orientation), this.system.debug && (this.shouldUpdateWireframe = !0), this.isLoaded = !0
                }
                this.el.body = this.body, this.body.el = el, this.isPlaying && this._play(), this.isLoaded && this.el.emit("body-loaded", {
                    body: this.el.body
                })
            },
            ...
            tick: function () {
                this.shouldUpdateBody && (this.isLoaded = !0, this._play(), this.el.emit("body-loaded", {
                    body: this.el.body
                }), this.shouldUpdateBody = !1), this.shouldUpdateWireframe && (this.createWireframe(this.body), this.shouldUpdateWireframe = !1)
            },
            play: function () {
                this.isLoaded && this._play()
            },
            _play: function () {
                this.syncToPhysics(), this.system.addComponent(this), this.system.addBody(this.body), this.wireframe && this.el.sceneEl.object3D.add(this.wireframe)
            },
            pause: function () {
                this.isLoaded && this._pause()
            },
            _pause: function () {
                this.system.removeComponent(this), this.body && this.system.removeBody(this.body), this.wireframe && this.el.sceneEl.object3D.remove(this.wireframe)
            },
            update: function (prevData) {
                if (this.body) {
                    var data = this.data;
                    void 0 != prevData.type && data.type != prevData.type && (this.body.type = "dynamic" === data.type ? CANNON.Body.DYNAMIC : CANNON.Body.STATIC), this.body.mass = data.mass || 0, "dynamic" === data.type && (this.body.linearDamping = data.linearDamping, this.body.angularDamping = data.angularDamping), data.mass !== prevData.mass && this.body.updateMassProperties(), this.body.updateProperties && this.body.updateProperties()
                }
            },
            remove: function () {
                this.body && (delete this.body.el, delete this.body), delete this.el.body, delete this.wireframe
            },
            beforeStep: function () {
            ...
            createWireframe: function (body) {
                var offset, mesh;
                this.wireframe && (this.el.sceneEl.object3D.remove(this.wireframe), delete this.wireframe), this.wireframe = new THREE.Object3D, this.el.sceneEl.object3D.add(this.wireframe);
                for (var orientation = new THREE.Quaternion, i = 0; i < this.body.shapes.length; i++) {
                    ...
                    offset && wireframe.position.copy(offset), orientation && wireframe.quaternion.copy(orientation), this.wireframe.add(wireframe)
                }
                this.syncWireframe()
            },
            syncWireframe: function () {
                var offset, wireframe = this.wireframe;
                this.wireframe && (wireframe.quaternion.copy(this.body.quaternion), wireframe.orientation && wireframe.quaternion.multiply(wireframe.orientation), wireframe.position.copy(this.body.position), wireframe.offset && (offset = wireframe.offset.clone().applyQuaternion(wireframe.quaternion), wireframe.position.add(offset)), wireframe.updateMatrix())
            },
            syncToPhysics: (q = new THREE.Quaternion, v = new THREE.Vector3, function () {
                var el = this.el,
                    parentEl = el.parentEl,
                    body = this.body;
                body && (el.components.velocity && body.velocity.copy(el.getAttribute("velocity")), parentEl.isScene ? (body.quaternion.copy(el.object3D.quaternion), body.position.copy(el.object3D.position)) : (el.object3D.getWorldQuaternion(q), body.quaternion.copy(q), el.object3D.getWorldPosition(v), body.position.copy(v)), this.body.updateProperties && this.body.updateProperties(), this.wireframe && this.syncWireframe())
            }),
            syncFromPhysics: function () {
    ...
    71: [function (require, module, exports) {
        module.exports = {
            ...
            registerAll: function (AFRAME) {
                this._registered || ((AFRAME = AFRAME || window.AFRAME).components.velocity || AFRAME.registerComponent("velocity", this.velocity), this._registered = !0)
            }
        }
    }, {
        "./velocity": 72
    ...
    73: [function (require, module, exports) {
        ...
        var AmmoShape = {
            ...
            remove: function () {
                if (this.body)
                    for (this.body.removeShapeComponent(this); this.collisionShapes.length > 0;) {
    ...
    74: [function (require, module, exports) {
        var CANNON = require("cannon"),
            Shape = {
                ...
                initShape: function () {
                    this.bodyEl = this.el;
                    for (var bodyType = this._findType(this.bodyEl), data = this.data; !bodyType && this.bodyEl.parentNode != this.el.sceneEl;) this.bodyEl = this.bodyEl.parentNode, bodyType = this._findType(this.bodyEl);
                    if (bodyType) {
                        var shape, offset, orientation, scale = new THREE.Vector3;
                        switch (this.bodyEl.object3D.getWorldScale(scale), data.hasOwnProperty("offset") && (offset = new CANNON.Vec3(data.offset.x * scale.x, data.offset.y * scale.y, data.offset.z * scale.z)), data.hasOwnProperty("orientation") && (orientation = new CANNON.Quaternion).copy(data.orientation), data.shape) {
                            case "sphere":
                            ...
                            case "cylinder":
                                ...
                                quat.setFromEuler(90 * THREE.Math.DEG2RAD, 0, 0, "XYZ").normalize(), orientation.mult(quat, orientation);
                                break;
                            default:
    ...
    75: [function (require, module, exports) {
        ...
        module.exports = AFRAME.registerComponent("spring", {
            ...
            init: function () {
                this.system = this.el.sceneEl.systems.physics, this.system.addComponent(this), this.isActive = !0, this.spring = null
            },
            update: function (oldData) {
                var el = this.el,
                    data = this.data;
                data.target ? el.body && data.target.body ? (this.createSpring(), this.updateSpring(oldData)) : (el.body ? data.target : el).addEventListener("body-loaded", this.update.bind(this, {})) : console.warn("Spring: invalid target specified.")
            },
    ...
    77: [function (require, module, exports) {
        ...
        AmmoDriver.prototype = new Driver, AmmoDriver.prototype.constructor = AmmoDriver, module.exports = AmmoDriver, AmmoDriver.prototype.init = function (worldConfig) {
            ...
            this.els.delete(bodyptr), this.collisions.delete(bodyptr), this.collisionKeys.splice(this.collisionKeys.indexOf(bodyptr), 1), this.currentCollisions.delete(bodyptr)
            ...
            for (let i = 0; i < numManifolds; i++) {
                const persistentManifold = this.dispatcher.getManifoldByIndexInternal(i),
                    numContacts = persistentManifold.getNumContacts(),
                    body0ptr = Ammo.getPointer(persistentManifold.getBody0()),
                    body1ptr = Ammo.getPointer(persistentManifold.getBody1());
                let collided = !1;
                ...
                collided && (this.collisions.has(body0ptr) || (this.collisions.set(body0ptr, []), this.collisionKeys.push(body0ptr)), -1 === this.collisions.get(body0ptr).indexOf(body1ptr) && (this.collisions.get(body0ptr).push(body1ptr), -1 !== this.eventListeners.indexOf(body0ptr) && this.els.get(body0ptr).emit("collidestart", {
                ...
                })), this.currentCollisions.has(body0ptr) || this.currentCollisions.set(body0ptr, new Set), this.currentCollisions.get(body0ptr).add(body1ptr))
            }
            for (let i = 0; i < this.collisionKeys.length; i++) {
                const body0ptr = this.collisionKeys[i],
                    body1ptrs = this.collisions.get(body0ptr);
            ...
            const ptr = Ammo.getPointer(body); - 1 !== this.eventListeners.indexOf(ptr) && this.eventListeners.splice(this.eventListeners.indexOf(ptr), 1)
        }, AmmoDriver.prototype.destroy = function () {
            Ammo.destroy(this.collisionConfiguration), Ammo.destroy(this.dispatcher), Ammo.destroy(this.broadphase), Ammo.destroy(this.solver), Ammo.destroy(this.physicsWorld), Ammo.destroy(this.debugDrawer)
        }, AmmoDriver.prototype.getDebugDrawer = function (scene, options) {
            return this.debugDrawer || ((options = options || {}).debugDrawMode = options.debugDrawMode || this.debugDrawMode, this.debugDrawer = new THREE.AmmoDebugDrawer(scene, this.physicsWorld, options)), this.debugDrawer
        }
    }, {
        "./driver": 78
    }],
    78: [function (require, module, exports) {
        ...
        module.exports = Driver, Driver.prototype.init = abstractMethod, Driver.prototype.step = abstractMethod, Driver.prototype.destroy = abstractMethod, Driver.prototype.addBody = abstractMethod, Driver.prototype.removeBody = abstractMethod, Driver.prototype.applyBodyMethod = abstractMethod, Driver.prototype.updateBodyProperties = abstractMethod, Driver.prototype.addMaterial = abstractMethod, Driver.prototype.addContactMaterial = abstractMethod, Driver.prototype.addConstraint = abstractMethod, Driver.prototype.removeConstraint = abstractMethod, Driver.prototype.getContacts = abstractMethod
    }, {}],
    ...
    80: [function (require, module, exports) {
        ...
        LocalDriver.prototype = new Driver, LocalDriver.prototype.constructor = LocalDriver, module.exports = LocalDriver, LocalDriver.prototype.init = function (worldConfig) {
            var world = new CANNON.World;
            world.quatNormalizeSkip = worldConfig.quatNormalizeSkip, world.quatNormalizeFast = worldConfig.quatNormalizeFast, world.solver.iterations = worldConfig.solverIterations, world.gravity.set(0, worldConfig.gravity, 0), world.broadphase = new CANNON.NaiveBroadphase, this.world = world
            ...
            this.materials[materialConfig.name] = new CANNON.Material(materialConfig), this.materials[materialConfig.name].name = materialConfig.name
            ...
            this.contactMaterial = new CANNON.ContactMaterial(mat1, mat2, contactMaterialConfig), this.world.addContactMaterial(this.contactMaterial)
        }, LocalDriver.prototype.addConstraint = function (constraint) {
            constraint.type || (constraint instanceof CANNON.LockConstraint ? constraint.type = "LockConstraint" : constraint instanceof CANNON.DistanceConstraint ? constraint.type = "DistanceConstraint" : constraint instanceof CANNON.HingeConstraint ? constraint.type = "HingeConstraint" : constraint instanceof CANNON.ConeTwistConstraint ? constraint.type = "ConeTwistConstraint" : constraint instanceof CANNON.PointToPointConstraint && (constraint.type = "PointToPointConstraint")), this.world.addConstraint(constraint)
    ...
    81: [function (require, module, exports) {
        ...
        NetworkDriver.prototype = new Driver, NetworkDriver.prototype.constructor = NetworkDriver, module.exports = NetworkDriver
    }, {
        "./driver": 78
    }],
    82: [function (require, module, exports) {
        ...
        module.exports = function (worker) {
            ...
            return targetA.setTarget(targetB), targetB.setTarget(targetA), worker(targetA), targetB
    ...
    83: [function (require, module, exports) {
        ...
        function WorkerDriver(options) {
            this.fps = options.fps, this.engine = options.engine, this.interpolate = options.interpolate, this.interpBufferSize = options.interpolationBufferSize, this.debug = options.debug, this.bodies = {}, this.contacts = [], this.frameDelay = 1e3 * this.interpBufferSize / this.fps, this.frameBuffer = [], this.worker = this.debug ? webworkifyDebug(worker) : webworkify(worker), this.worker.addEventListener("message", this._onMessage.bind(this))
        }
        WorkerDriver.prototype = new Driver, WorkerDriver.prototype.constructor = WorkerDriver, module.exports = WorkerDriver, WorkerDriver.prototype.init = function (worldConfig) {
            ...
            if (this.interpolate) {
                for (var prevFrame = this.frameBuffer[0], nextFrame = this.frameBuffer[1], timestamp = performance.now(); prevFrame && nextFrame && timestamp - prevFrame.timestamp > this.frameDelay;) this.frameBuffer.shift(), prevFrame = this.frameBuffer[0], nextFrame = this.frameBuffer[1];
                if (prevFrame && nextFrame) {
                    var mix = (timestamp - prevFrame.timestamp) / this.frameDelay;
                    for (var id in mix = (mix - (1 - 1 / this.interpBufferSize)) * this.interpBufferSize, prevFrame.bodies) prevFrame.bodies.hasOwnProperty(id) && nextFrame.bodies.hasOwnProperty(id) && protocol.deserializeInterpBodyUpdate(prevFrame.bodies[id], nextFrame.bodies[id], this.bodies[id], mix)
                }
            }
            ...
            if (event.data.type === Event.STEP) {
                ...
                if (this.contacts = event.data.contacts, this.interpolate) this.frameBuffer.push({
                    ...
                    for (var id in bodies) bodies.hasOwnProperty(id) && protocol.deserializeBodyUpdate(bodies[id], this.bodies[id])
            } else {
                ...
                var body = this.bodies[event.data.bodyID],
                    target = this.bodies[event.data.targetID],
                    contact = protocol.deserializeContact(event.data.contact, this.bodies);
            ...
            constraint.type || (constraint instanceof CANNON.LockConstraint ? constraint.type = "LockConstraint" : constraint instanceof CANNON.DistanceConstraint ? constraint.type = "DistanceConstraint" : constraint instanceof CANNON.HingeConstraint ? constraint.type = "HingeConstraint" : constraint instanceof CANNON.ConeTwistConstraint ? constraint.type = "ConeTwistConstraint" : constraint instanceof CANNON.PointToPointConstraint && (constraint.type = "PointToPointConstraint")), protocol.assignID("constraint", constraint), this.worker.postMessage({
    ...
    84: [function (require, module, exports) {
        ...
        module.exports = function (self) {
            ...
            self.addEventListener("message", function (event) {
                ...
                switch (data.type) {
                    case Event.INIT:
                        (driver = "cannon" === data.engine ? new LocalDriver : new AmmoDriver).init(data.worldConfig), stepSize = 1 / data.fps, setInterval(step, 1e3 / data.fps);
                        break;
                    case Event.ADD_BODY:
                        var body = protocol.deserializeBody(data.body);
                        body.material = driver.getMaterial("defaultMaterial"), bodies[body[ID]] = body, body.addEventListener("collide", function (evt) {
                            var message = {
                                type: Event.COLLIDE,
    ...
    85: [function (require, module, exports) {
        ...
        module.exports = AFRAME.registerSystem("physics", {
            ...
            tick: function (t, dt) {
                if (this.initialized && dt) {
                    ...
                    for (this.driver.step(Math.min(dt / 1e3, this.data.maxInterval)), i = 0; i < callbacks.step.length; i++) callbacks.step[i].step(t, dt);
                    for (i = 0; i < callbacks.afterStep.length; i++) callbacks.afterStep[i].afterStep(t, dt)
                }
            },
            setDebug: function (debug) {
                this.debug = debug, "ammo" === this.data.driver && this.initialized && (debug && !this.debugDrawer ? (this.debugDrawer = this.driver.getDebugDrawer(this.el.object3D), this.debugDrawer.enable()) : this.debugDrawer && (this.debugDrawer.disable(), this.debugDrawer = null))
            },
            addBody: function (body, group, mask) {
                var driver = this.driver;
                "local" === this.data.driver && (body.__applyImpulse = body.applyImpulse, body.applyImpulse = function () {
            ...
            removeBody: function (body) {
                this.driver.removeBody(body), "local" !== this.data.driver && "worker" !== this.data.driver || (body.removeEventListener("collide", this.listeners[body.id]), delete this.listeners[body.id], body.applyImpulse = body.__applyImpulse, delete body.__applyImpulse, body.applyForce = body.__applyForce, delete body.__applyForce, delete body.updateProperties)
            },
            ...
            addComponent: function (component) {
                ...
                component.beforeStep && callbacks.beforeStep.push(component), component.step && callbacks.step.push(component), component.afterStep && callbacks.afterStep.push(component)
            },
            removeComponent: function (component) {
                var callbacks = this.callbacks;
                component.beforeStep && callbacks.beforeStep.splice(callbacks.beforeStep.indexOf(component), 1), component.step && callbacks.step.splice(callbacks.step.indexOf(component), 1), component.afterStep && callbacks.afterStep.splice(callbacks.afterStep.indexOf(component), 1)
            },
        ...
        "./constants": 76,
        "./drivers/ammo-driver": 77,
        "./drivers/local-driver": 80,
        "./drivers/network-driver": 81,
        "./drivers/worker-driver": 83,
        cannon: 5
    }],
    86: [function (require, module, exports) {
        module.exports.slerp = function (a, b, t) {
            ...
            if ((a = a.slice())[3] = -b[3], a[0] = -b[0], a[1] = -b[1], a[2] = -b[2], (cosHalfTheta = -cosHalfTheta) >= 1) return a[3] = w, a[0] = x, a[1] = y, a[2] = z, this;
            var sinHalfTheta = Math.sqrt(1 - cosHalfTheta * cosHalfTheta);
            if (Math.abs(sinHalfTheta) < .001) return a[3] = .5 * (w + a[3]), a[0] = .5 * (x + a[0]), a[1] = .5 * (y + a[1]), a[2] = .5 * (z + a[2]), this;
            var halfTheta = Math.atan2(sinHalfTheta, cosHalfTheta),
                ratioA = Math.sin((1 - t) * halfTheta) / sinHalfTheta,
                ratioB = Math.sin(t * halfTheta) / sinHalfTheta;
            return a[3] = w * ratioA + a[3] * ratioB, a[0] = x * ratioA + a[0] * ratioB, a[1] = y * ratioA + a[1] * ratioB, a[2] = z * ratioA + a[2] * ratioB, a
        }
    }, {}],
    87: [function (require, module, exports) {
        ...
        function serializeShape(shape) {
            ...
            if (shape.type === CANNON.Shape.types.BOX) shapeMsg.halfExtents = serializeVec3(shape.halfExtents);
            else if (shape.type === CANNON.Shape.types.SPHERE) shapeMsg.radius = shape.radius;
            else {
                if (shape._type !== CANNON.Shape.types.CYLINDER) throw new Error("Unimplemented shape type: %s", shape.type);
                shapeMsg.type = CANNON.Shape.types.CYLINDER, shapeMsg.radiusTop = shape.radiusTop, shapeMsg.radiusBottom = shape.radiusBottom, shapeMsg.height = shape.height, shapeMsg.numSegments = shape.numSegments
            }
            return shapeMsg
        }
        ...
        function deserializeShape(message) {
            var shape;
            if (message.type === CANNON.Shape.types.BOX) shape = new CANNON.Box(deserializeVec3(message.halfExtents));
            else if (message.type === CANNON.Shape.types.SPHERE) shape = new CANNON.Sphere(message.radius);
            else {
        ...
        module.exports.assignID = function (prefix, object) {
            ...
            return body.position.set(message.position[0], message.position[1], message.position[2]), body.quaternion.set(message.quaternion[0], message.quaternion[1], message.quaternion[2], message.quaternion[3]), body.velocity.set(message.velocity[0], message.velocity[1], message.velocity[2]), body.angularVelocity.set(message.angularVelocity[0], message.angularVelocity[1], message.angularVelocity[2]), body.linearDamping = message.linearDamping, body.angularDamping = message.angularDamping, body.fixedRotation = message.fixedRotation, body.allowSleep = message.allowSleep, body.sleepSpeedLimit = message.sleepSpeedLimit, body.sleepTimeLimit = message.sleepTimeLimit, body.mass !== message.mass && (body.mass = message.mass, body.updateMassProperties()), body
        ...
        }, module.exports.serializeShape = serializeShape, module.exports.deserializeShape = deserializeShape, module.exports.serializeConstraint = function (constraint) {
            var message = {
                id: constraint[ID],
            ...
            switch (constraint.type) {
                ...
                case "ConeTwistConstraint":
                    message.axisA = serializeVec3(constraint.axisA), message.axisB = serializeVec3(constraint.axisB), message.pivotA = serializeVec3(constraint.pivotA), message.pivotB = serializeVec3(constraint.pivotB);
                    break;
            ...
            var constraint, TypedConstraint = CANNON[message.type],
                bodyA = bodies[message.bodyA],
                bodyB = bodies[message.bodyB];
            switch (message.type) {
                case "LockConstraint":
        ...
        }, module.exports.serializeVec3 = serializeVec3, module.exports.deserializeVec3 = deserializeVec3, module.exports.serializeQuaternion = serializeQuaternion, module.exports.deserializeQuaternion = deserializeQuaternion
    }, {
        "./math": 86,
        cannon: 5
    }]
